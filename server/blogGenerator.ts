...
const TOPIC_LIBRARY: Array<{ topic: string; category: string }> = [
  ...
  {
    topic: "Documents checklist for UK Innovator Founder Visa application",
    category: "guides",
  },
  {
    topic:
  ...
  {
    topic: "Preparing for your biometric appointment: What to bring and expect",
    category: "guides",
  },
  {
    topic: "How to track your UK visa application status after submission",
    category: "guides",
  },
  {
    topic:
      "What happens after you submit your Innovator Founder Visa application",
    category: "visa-updates",
  },
  {
    topic:
      "How to use the UK Visas and Immigration online portal for your application",
    category: "guides",
  },
  {
    topic: "Priority processing for UK Innovator Founder Visa: Is it worth it?",
    category: "visa-updates",
  },
  {
    topic:
  ...
  {
    topic:
      "Applying for the UK Innovator Founder Visa from outside the UK: Entry clearance guide",
    category: "uk-immigration",
  },
  {
    topic:
      "Immigration Health Surcharge explained for Innovator Founder Visa applicants",
    category: "uk-immigration",
  },
  {
    topic:
      "How long does an Innovator Founder Visa application take to process?",
    category: "visa-updates",
  },
  {
    topic: "What to do if your Innovator Founder Visa application is refused",
    category: "uk-immigration",
  },
  {
    topic: "UK Innovator Founder Visa administrative review process explained",
    category: "uk-immigration",
  },
  ...
  {
    topic: "How to prove the £50,000 maintenance fund requirement for UK visa",
    category: "guides",
  },
  {
    topic:
      "What counts as acceptable funds for the UK Innovator Founder Visa financial requirement",
    category: "guides",
  },
  {
    topic:
      "How long must you hold the £50,000 before applying for the Innovator Founder Visa",
    category: "visa-updates",
  },
  {
    topic:
      "Bank statements and financial evidence: What UK visa officers look for",
    category: "guides",
  },
  {
    topic:
      "Do Innovator Founder Visa holders need £50,000 for extensions and renewals?",
    category: "visa-updates",
  },
  {
    topic:
      "Investor funding vs personal savings: Which counts for your visa financial requirement",
    category: "business-planning",
  },
  {
    topic:
      "How to explain large deposits in your bank statements for UK visa applications",
    category: "guides",
  },
  ...
  {
    topic:
      "Choosing an endorsing body: Factors to consider for UK Innovator Founder Visa",
    category: "endorsement",
  },
  {
    topic:
      "What endorsing bodies actually look for when assessing your business idea",
    category: "endorsement",
  },
  {
    topic:
      "How to demonstrate innovation to your Innovator Founder Visa endorsing body",
    category: "endorsement",
  },
  {
    topic: "How to prove viability to a UK endorsing body: A practical guide",
    category: "endorsement",
  },
  {
    topic:
      "Demonstrating scalability: What endorsing bodies want to see in your business plan",
    category: "endorsement",
  },
  {
    topic:
  ...
  {
    topic: "Endorsement rejection: Common reasons and how to appeal or reapply",
    category: "endorsement",
  },
  {
    topic:
      "What documents does an endorsing body require before the interview?",
    category: "endorsement",
  },
  {
    topic:
      "How to research and compare the three UK Innovator Founder Visa endorsing bodies",
    category: "endorsement",
  },
  {
    topic: "Envestors Limited as an endorsing body: What you need to know",
    category: "endorsement",
  },
  {
    topic:
      "Innovator International Limited as an endorsing body: What applicants should know",
    category: "endorsement",
  },
  {
    topic: "UK Endorsing Services (UKES): A guide for visa applicants",
    category: "endorsement",
  },
  {
    topic:
      "What is the Global Entrepreneurs Programme and who qualifies for it?",
    category: "endorsement",
  },
  {
    topic: "How many endorsing body applications can you make if rejected?",
    category: "endorsement",
  },
  {
    topic:
      "How long does endorsement last and when does it need to be renewed?",
    category: "endorsement",
  },

  // ── CONTACT POINT MEETINGS ─────────────────────────────────────────────────
  {
    topic: "Contact point meetings: What to expect and how to prepare",
    category: "endorsement",
  },
  {
    topic:
      "Your 6-month contact point meeting: What to report and how to prepare",
    category: "endorsement",
  },
  {
    topic:
      "Your 12-month contact point meeting: Progress milestones your endorser expects",
    category: "endorsement",
  },
  {
    topic:
      "Your 24-month contact point meeting: What you need to show for ILR eligibility",
    category: "endorsement",
  },
  {
    topic:
      "What evidence of business progress do you need for contact point meetings?",
    category: "endorsement",
  },
  {
    topic: "How to prepare your business update report for your endorsing body",
    category: "business-planning",
  },
  {
    topic: "What happens if you miss or fail a contact point meeting?",
    category: "endorsement",
  },
  ...
  {
    topic:
      "ILR requirements for Innovator Founder Visa holders: A complete checklist",
    category: "uk-immigration",
  },
  {
    topic:
      "The Life in the UK test: A guide for Innovator Founder Visa holders seeking ILR",
    category: "uk-immigration",
  },
  {
    topic:
      "How absences from the UK affect your eligibility for Indefinite Leave to Remain",
    category: "uk-immigration",
  },
  {
    topic:
      "ILR to British citizenship: What Innovator Founder Visa holders need to know",
    category: "uk-immigration",
  },
  {
    topic:
      "English language requirements for ILR: What level is needed after Innovator Founder Visa",
    category: "uk-immigration",
  },
  {
    topic:
      "Can you count time on other visa routes towards ILR after getting an Innovator Founder Visa?",
    category: "uk-immigration",
  },
  ...
  {
    topic:
      "Understanding absences: How time outside the UK affects your Innovator Founder Visa",
    category: "visa-updates",
  },
  {
    topic:
      "When endorsement can be withdrawn: Avoiding common compliance pitfalls",
    category: "endorsement",
  },
  {
    topic: "Extending your Innovator Founder Visa: Requirements and timeline",
    category: "visa-updates",
  },
  {
    topic:
      "What counts as a 'significant change' that must be reported to your endorsing body?",
    category: "endorsement",
  },
  {
    topic:
      "How to notify your endorsing body if your business changes direction",
    category: "endorsement",
  },
  {
    topic:
      "Can you work for another employer while on the Innovator Founder Visa?",
    category: "visa-updates",
  },
  {
    topic:
      "Can you pursue a second business while on the Innovator Founder Visa?",
    category: "visa-updates",
  },
  {
    topic: "What happens to your visa if your endorsed business fails?",
    category: "visa-updates",
  },
  {
    topic:
      "How to keep your Innovator Founder Visa compliant if you pivot your business model",
    category: "visa-updates",
  },
  ...
  {
    topic:
      "Bringing your family to the UK: Dependent visa guide for Innovator Founder Visa holders",
    category: "uk-immigration",
  },
  {
    topic: "Can your spouse or partner work in the UK on a dependent visa?",
    category: "uk-immigration",
  },
  {
    topic:
      "Bringing children to the UK on the Innovator Founder Visa dependent route",
    category: "uk-immigration",
  },
  {
    topic:
      "School enrollment for children of Innovator Founder Visa holders in the UK",
    category: "uk-immigration",
  },
  {
    topic: "NHS access for Innovator Founder Visa holders and their dependants",
    category: "uk-immigration",
  },
  {
    topic:
      "What happens to dependants if the main Innovator Founder Visa holder's visa is refused or revoked?",
    category: "uk-immigration",
  },

  // ── BUSINESS PLANNING ─────────────────────────────────────────────────────
  {
    topic: "Creating financial projections for your UK visa business plan",
    category: "business-planning",
  },
  {
    topic:
  ...
  {
    topic: "Common business plan mistakes that lead to endorsement rejection",
    category: "business-planning",
  },
  {
    topic:
      "How to structure a UK Innovator Founder Visa business plan: A complete template",
    category: "business-planning",
  },
  {
    topic:
      "What is an innovation statement and how do you write one that passes endorsement?",
    category: "business-planning",
  },
  {
    topic: "How to show your business idea is genuinely new in the UK market",
    category: "business-planning",
  },
  {
    topic:
      "Revenue projections for early-stage startups: What endorsers expect to see",
    category: "business-planning",
  },
  {
    topic:
      "How to write a competitive analysis for your Innovator Founder Visa business plan",
    category: "business-planning",
  },
  {
    topic:
      "Job creation plans: What endorsers look for in your hiring strategy",
    category: "business-planning",
  },
  {
    topic:
      "How to present your team and founder background in your business plan",
    category: "business-planning",
  },
  {
    topic:
      "Intellectual property and patents: How they strengthen your Innovator Founder Visa application",
    category: "business-planning",
  },
  {
    topic:
      "How to demonstrate you have the skills to run your proposed UK business",
    category: "business-planning",
  },
  {
    topic:
      "Writing the executive summary for your UK Innovator Founder Visa business plan",
    category: "business-planning",
  },
  {
    topic:
      "What is a minimum viable product and does having one help your endorsement application?",
    category: "business-planning",
  },
  {
    topic:
      "How to handle a business plan that targets a niche market in the UK",
    category: "business-planning",
  },
  {
    topic:
      "Using a pitch deck alongside your business plan for the Innovator Founder Visa",
    category: "business-planning",
  },
  {
    topic:
      "How to quantify the social impact of your business for endorsement purposes",
    category: "business-planning",
  },
  {
    topic:
      "B2B vs B2C businesses: Does the model affect Innovator Founder Visa endorsement?",
    category: "business-planning",
  },
  ...
  {
    topic: "Opening a UK business bank account as an international founder",
    category: "guides",
  },
  {
    topic: "Innovate UK grants: How to apply and what qualifies",
    category: "business-planning",
  },
  {
    topic:
      "SEIS and EIS investor schemes: What Innovator Founder Visa holders need to know",
    category: "business-planning",
  },
  {
    topic:
      "R&D tax credits for UK startups founded on the Innovator Founder Visa",
    category: "business-planning",
  },
  {
    topic:
      "How to find angel investors and venture capital in the UK startup ecosystem",
    category: "business-planning",
  },
  {
    topic:
      "National Insurance obligations for Innovator Founder Visa holders who employ staff",
    category: "business-planning",
  },
  {
    topic: "VAT registration for early-stage UK startups: When and how",
    category: "business-planning",
  },
  {
    topic:
      "Corporation tax basics for UK startups founded under the Innovator Founder Visa",
    category: "business-planning",
  },
  {
    topic:
      "How to use UK startup incubators and accelerators as an Innovator Founder",
    category: "business-planning",
  },
  {
    topic:
      "University spinout partnerships: A route for tech founders on the Innovator Founder Visa",
    category: "endorsement",
  },
  {
    topic:
      "UK government support schemes for international entrepreneurs in 2026",
    category: "visa-updates",
  },
  {
    topic:
      "How UK free trade zones could benefit Innovator Founder Visa businesses",
    category: "business-planning",
  },
  ...
  {
    topic:
      "Accepted English language tests for the UK Innovator Founder Visa in 2026",
    category: "guides",
  },
  {
    topic:
      "IELTS vs PTE vs TOEFL: Which English test is best for your UK visa application?",
    category: "guides",
  },
  {
    topic:
      "English language exemptions for the UK Innovator Founder Visa: Who qualifies?",
    category: "guides",
  },
  {
    topic:
      "How to prepare for English language tests required for UK visa applications",
    category: "guides",
  },
  {
    topic:
      "How long are English language test results valid for UK visa purposes?",
    category: "visa-updates",
  },
  ...
  {
    topic:
      "Tech founders and the UK Innovator Founder Visa: What the endorsement criteria means for software businesses",
    category: "endorsement",
  },
  {
    topic:
      "Healthcare and medtech startups on the UK Innovator Founder Visa: Key considerations",
    category: "endorsement",
  },
  {
    topic:
      "Fintech founders applying for the UK Innovator Founder Visa: What endorsers look for",
    category: "endorsement",
  },
  {
    topic:
      "Green tech and sustainability businesses on the UK Innovator Founder Visa",
    category: "endorsement",
  },
  {
    topic:
      "EdTech founders and the UK Innovator Founder Visa: Meeting the innovation criterion",
    category: "endorsement",
  },
  {
    topic:
      "E-commerce businesses on the UK Innovator Founder Visa: Can they qualify?",
    category: "business-planning",
  },
  {
    topic:
      "AI and machine learning startups applying for the UK Innovator Founder Visa",
    category: "endorsement",
  },
  {
    topic:
      "Social enterprises and the UK Innovator Founder Visa: Meeting the endorsement criteria",
    category: "endorsement",
  },
  {
    topic:
      "Creative industry businesses on the UK Innovator Founder Visa: What you need to know",
    category: "business-planning",
  },
  {
    topic:
      "Manufacturing startups and the UK Innovator Founder Visa: Demonstrating scalability",
    category: "endorsement",
  },
  ...
  {
    topic:
      "Common reasons for UK Innovator Founder Visa refusal and how to avoid them",
    category: "guides",
  },
  {
    topic:
      "Why endorsement applications get rejected and how to strengthen yours",
    category: "endorsement",
  },
  {
    topic: "Document errors that cause UK visa refusal: How to avoid them",
    category: "guides",
  },
  {
    topic:
      "Financial evidence mistakes that lead to UK Innovator Founder Visa refusal",
    category: "guides",
  },
  {
    topic: "How misleading or inconsistent business plans lead to visa refusal",
    category: "business-planning",
  },
  {
    topic:
      "What happens if you provide incorrect information on a UK visa application?",
    category: "uk-immigration",
  },
  {
    topic:
      "UK visa refusal and the 10-year ban: How to avoid deception findings",
    category: "uk-immigration",
  },
  ...
  {
    topic:
      "When should you hire an immigration lawyer for your UK Innovator Founder Visa?",
    category: "guides",
  },
  {
    topic:
      "What is OISC and why does it matter when choosing an immigration adviser?",
    category: "guides",
  },
  {
    topic: "Regulated vs unregulated immigration advice: Risks to avoid",
    category: "guides",
  },
  {
    topic:
      "How to verify an immigration adviser's OISC registration before hiring them",
    category: "guides",
  },
  {
    topic:
      "What a qualified immigration solicitor can and cannot do for your visa",
    category: "guides",
  },
  ...
  {
    topic:
      "Renting accommodation in the UK as an Innovator Founder Visa holder",
    category: "guides",
  },
  {
    topic:
      "Getting a UK driving licence as an international entrepreneur on a visa",
    category: "guides",
  },
  {
    topic:
      "UK National Insurance number: How and when to apply as an Innovator Founder Visa holder",
    category: "guides",
  },
  {
    topic: "Opening a personal bank account in the UK as a visa holder",
    category: "guides",
  },
  {
    topic: "UK credit history: How to build it from scratch as a new arrival",
    category: "guides",
  },
  {
    topic:
      "Childcare options and costs in the UK for Innovator Founder Visa families",
    category: "guides",
  },
  {
    topic:
      "UK pension contributions for Innovator Founder Visa holders: What you need to know",
    category: "business-planning",
  },
];
...
async function pickUnusedTopic(
  ...
  try {
    ...
    existingTitles = (rows.rows as Array<{ title: string }>).map(
      (r) => r.title,
    );
  } catch {
  ...
  for (const entry of shuffled) {
    ...
    const tooSimilar = existingFingerprints.some(
      (ef) => fingerprintOverlap(fp, ef) >= 0.4,
    );
  ...
  console.warn(
    "[Blog] All topics already covered — cycling to least-recently-used topic",
  );
  return shuffled[0];
}
...
export async function isTitleTooSimilarToExisting(
  ...
  return allTitles.some(
    (t) => fingerprintOverlap(fp, topicFingerprint(t)) >= 0.6,
  );
}
...
Return ONLY valid JSON.`;
  ...
  if (OPENAI_API_KEY) {
    for (const oaiModel of OPENAI_GEN_MODELS) {
      try {
        ...
        if (!oaiRes.ok) {
          console.warn(
            `[Blog Generator] OpenAI ${oaiModel} HTTP ${oaiRes.status}: ${oaiData?.error?.message}`,
          );
          continue;
        }
        ...
        try {
          console.log(
            `[Blog Generator] Running triple-AI verification (OpenAI ${oaiModel})…`,
          );
          ...
          if (verificationResult.passed) {
            ...
            console.log(
              `[Blog Generator] ✓ Verification PASSED — Composite: ${verificationResult.compositeScore}/100. Auto-publishing.`,
            );
          } else {
            verificationStatus = "human_review";
            console.warn(
              `[Blog Generator] ✗ Verification FAILED — Composite: ${verificationResult.compositeScore}/100. Sending to human review.`,
            );
          }
        } catch (verifyError) {
        ...
        return {
          ...
          authorBio:
            "Our team provides accurate, verified information about the UK Innovator Founder Visa process. All content is multi-AI verified by OpenAI and Gemini for factual accuracy against official GOV.UK sources.",
          ...
          verificationExpiresAt:
            verificationResult?.verificationExpiresAt ?? null,
          ...
          contentHash:
            verificationResult?.contentHash ?? computeContentHash(finalContent),
          isPublished,
          postStatus,
        };
      } catch (error: any) {
        console.error(
          `[Blog Generator] OpenAI ${oaiModel} failed:`,
          error?.message || error,
        );
      }
    }
  ...
  outer: for (const geminiModel of GEMINI_GENERATION_MODELS) {
    for (const apiKey of GEMINI_API_KEYS) {
      try {
        ...
        try {
          ...
          console.warn(
            `[Blog Generator] Gemini ${geminiModel} JSON parse error`,
          );
          continue; // next key
        }
        ...
        if (!geminiRes.ok) {
          const errMsg =
            geminiData?.error?.message || geminiRaw.substring(0, 150);
          const status = geminiRes.status;
          console.warn(
            `[Blog Generator] Gemini ${geminiModel} HTTP ${status}: ${errMsg.substring(0, 120)}`,
          );
        ...
        const contentHasDisclaimer =
          parsed.content.includes("disclaimer-box") ||
          parsed.content.includes("Important Notice") ||
          parsed.content.includes("does not constitute");
        const contentHasInternalLinks =
          parsed.content.includes('href="/') ||
...
<p>Ready to start your UK visa journey? Explore <a href="/tools" class="text-primary hover:underline">our visa preparation tools</a>, use our <a href="/business-plan" class="text-primary hover:underline">Business Plan Generator</a>, or check our <a href="/faq" class="text-primary hover:underline">frequently asked questions</a>.</p>`;
          ...
          const disclaimerIndex = finalContent.indexOf(
            '<div class="disclaimer-box',
          );
          if (disclaimerIndex > 0) {
            finalContent =
              finalContent.slice(0, disclaimerIndex) +
              linksSection +
              finalContent.slice(disclaimerIndex);
          } else {
        ...
        if (criticalCount > 0) {
          console.warn(
            `[Blog Generator] ${criticalCount} issues remain after auto-correction. Proceeding with corrected content.`,
          );
        }
        ...
        if (criticalCount > 0) {
          console.warn(
            `[Blog Generator] Content published with ${criticalCount} warnings after max retries. Sending to triple-AI verification.`,
          );
        }
        ...
        try {
          console.log(
            "[Blog Generator] Running triple-AI verification (Gemini + OpenAI)...",
          );
          verificationResult = await verifyBlogPost(
            parsed.title,
            correctedContent,
          );
          ...
          if (verificationResult.passed) {
            ...
            postStatus = "draft";
            console.warn(
              `[Blog Generator] ✗ Verification FAILED — Composite: ${verificationResult.compositeScore}/100. Sending to human review queue.`,
            );
            console.warn(
              `[Blog Generator] Reason: ${verificationResult.details.consensusReason}`,
            );
          }
        } catch (verifyError) {
          console.error(
            "[Blog Generator] Triple-AI verification error:",
            verifyError,
          );
        ...
        return {
          ...
          author: "UK Visa Expert Team",
          authorBio:
            "Our team provides accurate, verified information about the UK Innovator Founder Visa process. All content is multi-AI verified by Gemini and OpenAI for factual accuracy against official GOV.UK sources.",
          ...
          contentHash:
            ...
            computeContentHash(correctedContent),
          isPublished,
          postStatus,
        };
      } catch (error: any) {
        console.error(
          `[Blog Generator] Gemini ${geminiModel} (key …${apiKey.slice(-6)}) failed:`,
          error?.message || error,
        );
...
export async function generateMultiplePosts(count: number = 5): Promise<
  Array<{
    title: string;
    slug: string;
    excerpt: string;
...
> {
  ...
  for (let i = 0; i < count; i++) {
    try {
      ...
      const isDuplicate = await isTitleTooSimilarToExisting(
        post.title,
        inBatchTitles,
      );
      if (isDuplicate) {
        console.warn(
          `[Blog Generator] Skipping duplicate title: "${post.title}"`,
        );
      } else {
      ...
      console.error(
        `[Blog Generator] Failed to generate post ${i + 1}:`,
        error,
      );
    }
  }
...
> {
  ...
  for (
    ...
    dayOffset >= 0 && posts.length < totalPosts;
    dayOffset--
  ) {
    ...
    for (let i = 0; i < postsForThisDay; i++) {
      try {
        console.log(
          `[Blog Generator] Generating backdated post ${posts.length + 1} of ${totalPosts} (Day -${dayOffset})...`,
        );
        const post = await generateBlogPost(inBatchTitles);
        const isDuplicate = await isTitleTooSimilarToExisting(
          post.title,
        ...
        if (isDuplicate) {
          console.warn(
            `[Blog Generator] Skipping duplicate backdated title: "${post.title}"`,
          );
          continue;
        }
        inBatchTitles.push(post.title);
        ...
        console.error(
          `[Blog Generator] Failed to generate backdated post:`,
          error,
        );
      }
    }
