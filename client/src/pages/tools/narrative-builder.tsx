...
export default function NarrativeBuilder() {
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    return (localStorage.getItem('narrative-builder-mode') as 'ai' | 'traditional') || 'ai';
  });
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2" data-testid="heading-narrative-builder">
                    ...
                    <Card className={narrativeStrength >= 80 ? "border-green-500" : narrativeStrength >= 60 ? "border-orange-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold" data-testid="text-narrative-strength">
                            {narrativeStrength}%
                          </p>
