...
const AI_TOOL_CONFIG: ToolConfig = {
  toolId: 'hiring-plan',
  toolName: 'UK Hiring Plan',
  agent: 'atlas',
  greeting: "Hello! I'm Atlas, your Growth Expert. Creating UK jobs is a critical requirement for the Innovator Founder Visa. Let me help you build a hiring plan that demonstrates your commitment to UK job creation - you'll need at least 2 FTE by Year 3!",
  questions: [
    {
      id: 'current-team',
      question: "What's your current team size? How many are UK-based, and what roles do they hold?",
      hint: "This establishes your baseline for demonstrating job creation",
      fieldKey: 'currentTeam'
    },
    {
      id: 'first-hire',
      question: "What's your first critical UK hire? Describe the role, salary range (GBP), and when you plan to fill it.",
      hint: "Focus on roles essential to achieving your business milestones",
      fieldKey: 'firstHire',
      minLength: 30
    },
    {
      id: 'year1-plan',
      question: "What's your Year 1 hiring plan? List the roles, quantities, and timeline for each position.",
      hint: "Be specific about UK vs. remote/international roles",
      fieldKey: 'year1Plan',
      minLength: 50
    },
    {
      id: 'year3-target',
      question: "What's your target headcount by Year 3? Remember: you need at least 2 FTE UK jobs for visa compliance. Aim higher for a stronger application.",
      hint: "10+ UK jobs significantly strengthens your endorsement case",
      fieldKey: 'year3Target'
    },
    {
      id: 'budget',
      question: "What's your total hiring budget for the first 3 years? Include salaries, recruitment costs, and training.",
      hint: "This should align with your financial projections",
      fieldKey: 'hiringBudget'
    },
    {
      id: 'economic-impact',
      question: "What economic impact will your hiring have on the UK? Consider skills development, tax revenue, and market expertise you'll bring.",
      hint: "This strengthens your case for the 'genuine UK benefit' criterion",
      fieldKey: 'economicImpact',
      minLength: 50
    }
  ],
  completionMessage: "Fantastic! You've outlined a solid UK hiring plan. This directly demonstrates your commitment to creating UK jobs - essential for visa compliance. I'm populating your hiring plan now."
};
...
export default function HiringPlan() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('hiring-plan-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('hiring-plan-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
  ...
  useEffect(() => {
    localStorage.setItem('hiring-plan-mode', mode);
  }, [mode]);

  const handleAiComplete = (answers: Record<string, any>) => {
    if (answers.currentTeam) {
      const countMatch = answers.currentTeam.match(/(\d+)/);
      if (countMatch) {
        setTeamStructure(prev => ({
          ...prev,
          currentHeadcount: parseInt(countMatch[1])
        }));
      }
    }
    if (answers.firstHire) {
      setPositions([{
        id: '1',
        title: answers.firstHire.split(/[,-]/)[0]?.trim() || 'First Hire',
        ...
        yearTarget: 1,
        targetSalary: 0,
        requirements: answers.firstHire,
        sourcing: 'Direct/Agencies',
        ukBased: true,
        visaSponsorship: false,
        startDate: '',
        completionDate: '',
    ...
    if (answers.year3Target) {
      const countMatch = answers.year3Target.match(/(\d+)/);
      if (countMatch) {
        setTeamStructure(prev => ({
          ...prev,
          targetHeadcount: parseInt(countMatch[1]),
          year3FTE: parseInt(countMatch[1])
        }));
      }
    }
    if (answers.economicImpact) {
      setUkJobCreationNotes(prev => ({
        ...prev,
        economicImpact: answers.economicImpact
      }));
    }
    setMode('traditional');
  };
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-xl font-bold mb-2" data-testid="heading-hiring-plan">Strategic Hiring Plan</h1>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p>Atlas, our Growth Expert, helps you build a strategic hiring plan for UK job creation.</p>
                  <ul className="space-y-2 list-disc list-inside">
                    <li>Plan your current and future team structure</li>
                    <li>Identify critical hiring priorities</li>
                    <li>Demonstrate UK economic impact</li>
                    <li>Earn XP as you complete each question</li>
                  </ul>
                  <p className="pt-2">Your answers will automatically populate the hiring plan when complete.</p>
                </div>
              </Card>
            </div>
          ) : (
            ...
            <Card className="border-primary/20">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold" data-testid="text-total-hires">{totalHeadcount}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={teamStructure.year3FTE >= 2 ? "border-green-500/20" : "border-destructive/20"}>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className={`text-xl font-bold ${teamStructure.year3FTE >= 2 ? 'text-green-600' : 'text-destructive'}`} data-testid="text-year3-fte">
            ...
            <Card className="border-green-500/20">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-green-600" data-testid="text-uk-jobs">{ukJobsCount}</p>
            ...
            <Card className="border-blue-500/20">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-blue-600" data-testid="text-salary-cost">£{(totalSalaryCost / 1000).toFixed(0)}K</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-500/20">
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-purple-600" data-testid="text-job-creation-score">{jobCreationScore}%</p>
