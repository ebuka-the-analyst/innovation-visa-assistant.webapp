        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2 gap-4 flex-wrap">
              <h1 className="text-xl font-bold" data-testid="heading-doc-organizer">Document Organizer</h1>
                    ...
                    <Card className={organizationScore >= 80 ? "border-green-500" : organizationScore >= 50 ? "border-orange-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-organization-score">{organizationScore}%</p>
                    ...
                    <Card className={criticalScore >= 100 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-orange-600" data-testid="text-critical-score">{criticalScore}%</p>
                    ...
                    <Card className={overdue > 0 ? "border-destructive" : "border-green-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-destructive" data-testid="text-overdue-count">{overdue}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-uploaded-count">{uploadedFiles.length}</p>
