...
const INITIAL_DOCUMENTS: DocumentItem[] = [
  ...
  { 
    ...
    uploadDate: '', 
    priority: 'Critical',
    checklist: ['6 Months Consecutive', 'Shows £50k Available', 'Bank Letterhead Present', 'Certified Copies'],
    checklistCompleted: 0,
    homeOfficeRequirement: 'Bank statements showing minimum £50,000 available funds. Must be dated within 3 months of application and show continuous availability.'
  },
  { 
    id: 'fin-2', 
    category: 'Financial Records', 
...
□ Financial evidence (£50,000 minimum, verified)
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-4">
                          <li>Minimum £50,000 available investment funds</li>
