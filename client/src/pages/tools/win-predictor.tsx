        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-xl font-bold mb-2" data-testid="heading-win-predictor">Visa Approval Win Predictor</h1>
                    ...
                    <div className="flex items-center justify-center mb-6">
                      <div className="relative w-64 h-64">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <p className="text-2xl font-bold" data-testid="text-approval-probability">{Math.round(approvalProbability)}%</p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center mb-4">
                      <p className="text-xl font-bold text-primary" data-testid="text-overall-score">{overallScore}/100</p>
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-primary min-w-[60px] text-right" data-testid="text-innovation-score">{scores.innovation}</span>
                      </div>
                      <Slider
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-primary min-w-[60px] text-right" data-testid="text-viability-score">{scores.viability}</span>
                      </div>
                      <Slider
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-primary min-w-[60px] text-right" data-testid="text-scalability-score">{scores.scalability}</span>
                      </div>
                      <Slider
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-primary min-w-[60px] text-right" data-testid="text-evidence-score">{scores.evidence}</span>
                      </div>
                      <Slider
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-primary min-w-[60px] text-right" data-testid="text-team-score">{scores.team}</span>
                      </div>
                      <Slider
                        value={[scores.team]}
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-lg font-bold text-primary min-w-[60px] text-right" data-testid="text-market-score">{scores.market}</span>
                      </div>
                      <Slider
                        value={[scores.market]}
                  ...
                  <div className="pt-6 border-t">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      <div className="text-center p-4 bg-muted rounded-lg">
                        ...
                        <p className="text-lg font-bold text-primary">{overallScore}/100</p>
                      </div>
                      <div className="text-center p-4 bg-muted rounded-lg">
                        <p className="text-sm text-muted-foreground mb-1">Approval Probability</p>
                        <p className="text-lg font-bold text-primary">{Math.round(approvalProbability)}%</p>
                      </div>
                        ...
                        <CardContent className="pt-6">
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="text-right">
                              <p className="text-xl font-bold text-primary mb-1" data-testid={`text-endorser-probability-${index}`}>{endorser.probability}%</p>
