...
export default function WinPredictor() {
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    return (localStorage.getItem('win-predictor-mode') as 'ai' | 'traditional') || 'ai';
  });
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={400}>
                    <RadarChart data={radarData}>
                      ...
                      <Radar name="Your Score" dataKey="value" stroke="#ffa536" fill="#ffa536" fillOpacity={0.6} />
                      <Tooltip />
                    </RadarChart>
                  </ResponsiveContainer>
                </CardContent>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={criteriaBreakdown}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Bar dataKey="weightedScore" fill="#ffa536" name="Weighted Score" />
