...
const AI_TOOL_CONFIG: ToolConfig = {
  ...
  questions: [
    ...
    },
    {
      ...
      hint: "Dividend allowance is £1,000 (2024/25). Tax rates: 8.75% basic, 33.75% higher",
...
TAX CALCULATIONS (2024/25 Tax Year)
${'-'.repeat(80)}
...
${'-'.repeat(80)}
This calculator provides estimates based on 2024/25 UK tax rates and visa requirements.
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-4xl font-bold mb-2" data-testid="heading-income-calculator">Income Calculator</h1>
            ...
            <TabsContent value="calculator" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>UK tax calculations based on 2024/25 rates and visa salary requirements</CardDescription>
                </CardHeader>
                    ...
                    <Card className={meetsVisaMinimum ? "border-green-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-2xl font-bold" data-testid="text-gross-income">£{totalGrossIncome.toLocaleString()}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-2xl font-bold text-destructive" data-testid="text-total-tax">£{totalTax.toLocaleString()}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-2xl font-bold text-green-600" data-testid="text-net-income">£{netIncome.toLocaleString()}</p>
                          <p className="text-xs text-muted-foreground mt-1">per year</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-2xl font-bold text-primary" data-testid="text-visa-score">{visaComplianceScore}%</p>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Based on UK 2024/25 tax year rates</CardDescription>
                </CardHeader>
                <CardContent>
