...
const AI_TOOL_CONFIG: ToolConfig = {
  ...
  toolName: 'Funding Strategy Planner',
  agent: 'sterling',
  greeting: "Hello! I'm Sterling, your Financial Planning Specialist. I'll help you develop a comprehensive funding strategy that aligns with your business stage and visa requirements. Let's build your roadmap to investment!",
  questions: [
    {
      id: 'funding-goal',
      question: "How much funding are you looking to raise, and what business stage are you at?",
      hint: "E.g., '£100,000 at MVP stage' or '£500,000 at early-revenue stage with £10K MRR'",
      fieldKey: 'fundingGoal',
      minLength: 30
    },
    {
      id: 'funding-timeline',
      question: "What's your ideal timeline to close this funding round?",
      hint: "Consider visa application timelines - most rounds take 3-6 months",
      fieldKey: 'fundingTimeline',
      minLength: 20
    },
    {
      id: 'investor-targets',
      question: "What types of investors are you targeting and why?",
      hint: "E.g., angels for expertise, VCs for scale, grants for non-dilutive funding",
      fieldKey: 'investorTargets',
      minLength: 50
    },
    {
      id: 'uk-advantage',
      question: "How does UK-based funding benefit your business strategy?",
      hint: "Include SEIS/EIS advantages, UK investor networks, government support programs",
      fieldKey: 'ukAdvantage',
      minLength: 40
    },
    {
      id: 'risk-mitigation',
      question: "What's your backup plan if primary funding falls through?",
      hint: "E.g., personal runway, bridge funding options, revenue sustainability",
      fieldKey: 'riskMitigation',
      minLength: 40
    }
  ],
  completionMessage: "Your funding strategy framework is set! Configure the Strategy tab with your specific parameters to get personalized recommendations and action plans."
};
...
export default function FundingStrategy() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('funding-strategy-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('funding-strategy-mode', 'traditional');
    }
  }, [isPaidUser, mode]);

  useEffect(() => {
    localStorage.setItem('funding-strategy-mode', mode);
  }, [mode]);
  ...
  const getSmartTips = () => {
    ...
    if (fundingGoal < 10000) {
      tips.push('Consider whether your funding goal is sufficient for your business plan - endorsers assess if funding is appropriate');
    }
  ...
  const generateActionPlan = () => {
    const stages = {
      'idea': [
        { week: "Week 1", action: "Assess personal savings and liquid assets available for your business plan", priority: "Critical" },
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-funding-strategy">Funding Strategy</h1>
