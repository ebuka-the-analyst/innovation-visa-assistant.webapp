...
const AI_TOOL_CONFIG: ToolConfig = {
  ...
  agent: 'nova',
  greeting: "Hello! I'm Nova, your Innovation Specialist. I'll help you validate and strengthen your Unique Selling Proposition - the core of demonstrating innovation to endorsing bodies. Let's make your USP compelling and defensible!",
  questions: [
    {
      id: 'usp-statement',
      question: "What is your Unique Selling Proposition in one clear sentence? What makes your solution different?",
      hint: "Make it specific and memorable - avoid generic claims",
      fieldKey: 'usp_statement',
      minLength: 30
    },
    {
      id: 'target-customer',
      question: "Who is your ideal target customer? Be as specific as possible about their characteristics and pain points.",
      hint: "The more specific, the more compelling your USP becomes",
      fieldKey: 'target_customer',
      minLength: 50
    },
    {
      id: 'key-differentiators',
      question: "What are your top 3 differentiators from existing solutions? What can you do that competitors cannot?",
      hint: "Focus on measurable, verifiable differences",
      fieldKey: 'differentiators',
      minLength: 50
    },
    {
      id: 'competitive-moat',
      question: "What is your competitive moat? How will you prevent competitors from copying your approach?",
      hint: "Consider IP, network effects, data advantages, or regulatory barriers",
      fieldKey: 'competitive_moat',
      minLength: 50
    },
    {
      id: 'innovation-evidence',
      question: "What evidence do you have of genuine innovation? Include patents, research, novel technology, or unique methodology.",
      hint: "Endorsers specifically assess innovation - provide concrete proof",
      fieldKey: 'innovation_evidence',
      minLength: 100
    },
    {
      id: 'market-validation',
      question: "What market validation do you have for your USP? Include customer testimonials, pilot results, or market research.",
      hint: "Third-party validation strengthens credibility significantly",
...
export default function USPValidator() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('usp-validator-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('usp-validator-mode', 'traditional');
    }
  }, [isPaidUser, mode]);

  useEffect(() => {
    localStorage.setItem('usp-validator-mode', mode);
  }, [mode]);

  const handleAiComplete = (answers: Record<string, string>) => {
    if (answers.usp_statement) setUspStatement(answers.usp_statement);
    if (answers.target_customer) setTargetCustomer(answers.target_customer);
    if (answers.differentiators) setKeyDifferentiators(answers.differentiators);
    if (answers.competitive_moat) setCompetitiveMoat(answers.competitive_moat);
    if (answers.innovation_evidence) setInnovationEvidence(answers.innovation_evidence);
    setMode('traditional');
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              <h1 className="text-xl font-bold mb-2" data-testid="heading-usp-validator">USP Validator</h1>
                    ...
                    <Card className={uspStrengthScore >= 75 ? "border-green-500" : uspStrengthScore >= 65 ? "border-orange-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-usp-strength">{uspStrengthScore}%</p>
                    ...
                    <Card className={evidenceCompleteness >= 70 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-evidence-completeness">{evidenceCompleteness}%</p>
