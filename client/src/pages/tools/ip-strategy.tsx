...
export default function Ip-strategy() {
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold">IP Strategy Advisor</h1>
          <p className="text-muted-foreground mt-2">IP and patent strategy</p>
        </div>
