...
export default function BusinessPlan() {
  ...
  const handleExport = () => {
    const report = `UK INNOVATOR FOUNDER VISA - COMPREHENSIVE BUSINESS PLAN
...
MILESTONES & TIMELINE
${'-'.repeat(80)}
${milestones.map(m => `${m.month}: ${m.milestone} [${m.status.toUpperCase()}]`).join('\n')}
...
NEXT STEPS
${'-'.repeat(80)}
1. Complete all sections to 100%
2. Gather supporting documentation
3. Have plan professionally reviewed
4. Submit to endorsing body
5. Prepare for interview/additional questions

${'='.repeat(80)}
Report generated by UK Innovator Founder Visa Assistant
© 2025 innovatorfoundervisaassistant.co.uk

DISCLAIMER: This business plan template is for guidance only. Consult with 
...
`;
    ...
    a.href = url;
    a.download = `business-plan-${Date.now()}.txt`;
