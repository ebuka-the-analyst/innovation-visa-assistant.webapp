...
export default function FundingChecker() {
  ...
  const complianceScore = Math.min(100, Math.round((verifiedFunding / 50000) * 100));
  ...
  const getSmartTips = () => {
    const tips = [];
    if (!meetsMinimum) tips.push("You need at least £50,000 in total available funds to meet visa requirements");
  ...
  const generateActionPlan = () => {
    return [
      ...
      { week: "Ongoing", action: "Maintain minimum £50k accessible throughout application period", priority: "Critical" },
    ];
  };
...
- Consider maintaining a buffer above £50k for safety
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground">Validate £50,000 investment requirement compliance</p>
            {savedDate && (
            ...
            <TabsContent value="checker" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>UK Innovator Founder Visa requires minimum £50,000 available investment</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  {!meetsMinimum && (
                    <Alert variant="destructive">
                      ...
                      <AlertDescription>
                        You are £{(50000 - totalFunding).toLocaleString()} short of the £50,000 minimum requirement. Add more funding sources to meet visa eligibility.
                      </AlertDescription>
                    </Alert>
                  )}
                  ...
                  {verifiedMeetsMinimum && (
                    <Alert className="border-green-500 bg-green-50 dark:bg-green-950">
                      ...
                      <AlertDescription className="text-green-600 dark:text-green-400">
                        Excellent! Your verified funding meets the £50,000 requirement. Ensure documentation is complete and up-to-date.
                      </AlertDescription>
                    </Alert>
                  )}
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium">Minimum £50,000 Investment</p>
