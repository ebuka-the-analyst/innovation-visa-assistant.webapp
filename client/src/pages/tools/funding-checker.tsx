...
export default function FundingChecker() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('funding-checker-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('funding-checker-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-funding-checker">Funding Checker</h1>
                    ...
                    <Card className={verifiedMeetsMinimum ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-green-600" data-testid="text-verified-funding">£{verifiedFunding.toLocaleString()}</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
