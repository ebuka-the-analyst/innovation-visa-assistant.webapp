        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-xl font-bold mb-2" data-testid="heading-growth-metrics">Growth Metrics Dashboard</h1>
                    ...
                    <Card className={healthScore >= 70 ? "border-green-500" : healthScore >= 55 ? "border-yellow-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className={`text-xl font-bold ${healthGrade.color}`} data-testid="text-health-score">{healthScore}%</p>
                    ...
                    <Card className={ltvCacRatio >= 3 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-ltv-cac-ratio">{ltvCacRatio.toFixed(2)}:1</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
                            {ltvCacRatio >= 3 ? (
                              <CheckCircle2 className="h-5 w-5 text-green-500" />
                            ) : (
                    ...
                    <Card className={churnRate <= 5 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-churn-rate">{churnRate}%</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
                            {churnRate <= 5 ? (
                              <CheckCircle2 className="h-5 w-5 text-green-500" />
                            ) : (
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-current-mrr">£{currentMRR.toLocaleString()}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-cac">£{cac.toLocaleString()}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-ltv">£{ltv.toLocaleString()}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-dau-mau">{dauMauRatio.toFixed(1)}%</p>
