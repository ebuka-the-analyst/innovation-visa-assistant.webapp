    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-evidence-validator">Evidence Validator</h1>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-total-items">{evidenceItems.length}</p>
                    ...
                    <Card className={criticalGaps === 0 ? "border-green-500 dark:border-green-500" : "border-orange-500 dark:border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-orange-600 dark:text-orange-400" data-testid="text-critical-gaps">{criticalGaps}</p>
                  ...
                  <div className="grid md:grid-cols-4 gap-4">
                    {Object.entries(EVIDENCE_CATEGORIES).map(([key, cat]) => (
                      <Card key={key} className="p-4">
                        ...
                        <p className="text-lg font-bold" style={{ color: cat.color }}>{getCategoryScore(key)}%</p>
