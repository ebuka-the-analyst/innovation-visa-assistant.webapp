...
export default function QuestionBank() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('question-bank-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('question-bank-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-xl font-bold mb-2" data-testid="heading-question-bank">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-green-600" data-testid="text-mastered-count">{mastered}</p>
                  <p className="text-sm text-emerald-600 mt-2">Keep going!</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-blue-600" data-testid="text-practice-count">{questionsPracticed}</p>
