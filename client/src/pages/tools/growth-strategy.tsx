...
export default function Growth-strategy() {
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold">Growth Strategy</h1>
          <p className="text-muted-foreground mt-2">Build growth strategy</p>
        </div>
