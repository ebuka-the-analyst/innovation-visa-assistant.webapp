            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-3xl font-bold" data-testid="text-questions-prepared">{preparedQuestions}</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-3xl font-bold text-green-600" data-testid="text-complete-answers">{questionsWithAnswers}</p>
                  <div className="flex items-center justify-center gap-2 mt-2">
