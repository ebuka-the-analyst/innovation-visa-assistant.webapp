...
const INTERVIEW_QUESTIONS: Omit<InterviewQuestion, 'prepared' | 'answer' | 'evidence' | 'framework'>[] = [
  ...
  },
  {
    id: 'q9',
    category: 'financials',
    question: 'How will you use the £50,000 investment? Provide a breakdown.',
  },
  {
    id: 'q10',
    category: 'financials',
...
const PRACTICE_SCENARIOS: Omit<PracticeScenario, 'completed'>[] = [
  ...
  },
  {
    ...
    difficulty: 'medium',
    scenario: 'The panel questions the source of your £50,000 investment funds and asks for detailed documentation.',
    keyPoints: [
  ...
  const handleExportWord = async () => {
    ...
    await generateWord({
      ...
      metadata: {
        ...
        keywords: ['interview prep', 'innovator visa', 'UK visa', 'endorsement']
      }
    });
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium">Example:</p>
                        <p className="text-sm text-muted-foreground italic">
                          "As you can see in the bank verification letter dated March 15th, the full £50,000 is accessible..."
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium">Example:</p>
                        <p className="text-sm text-muted-foreground italic">
                          "According to Gartner's 2024 report, our market is expected to grow to £2.3B by 2027..."
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium">Example:</p>
                        <p className="text-sm text-muted-foreground italic">
                          "Beta launch January 2024, first paying customer February, 50 customers by April, 340 by July..."
                        </p>
                      </div>
                    </div>
