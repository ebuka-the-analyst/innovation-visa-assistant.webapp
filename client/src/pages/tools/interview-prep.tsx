        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-xl font-bold mb-2" data-testid="heading-interview-prep">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-primary" data-testid="text-preparedness-score">{preparednessScore}%</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold" data-testid="text-questions-prepared">{preparedQuestions}</p>
                  <div className="flex items-center justify-center gap-2 mt-2">
                    {preparedQuestions === totalQuestions ? (
                      <CheckCircle2 className="h-5 w-5 text-green-500" />
                    ) : (
                      <p className="text-sm text-emerald-600">Keep going!</p>
                    )}
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-green-600" data-testid="text-complete-answers">{questionsWithAnswers}</p>
                  <div className="flex items-center justify-center gap-2 mt-2">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-blue-600" data-testid="text-scenarios-completed">{completedScenarios}/{totalScenarios}</p>
                  <div className="flex items-center justify-center gap-2 mt-2">
