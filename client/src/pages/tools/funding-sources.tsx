...
export default function FundingSources() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('funding-sources-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('funding-sources-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-funding-sources">Funding Sources</h1>
                ...
                <Card className={meetsMinimum ? "border-green-500" : "border-destructive"}>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold" data-testid="text-total-funding">£{totalFunding.toLocaleString()}</p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold text-green-600" data-testid="text-verified">£{verifiedFunding.toLocaleString()}</p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold text-primary" data-testid="text-visa-approved">£{visaApprovedFunding.toLocaleString()}</p>
