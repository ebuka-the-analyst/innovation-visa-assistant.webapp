...
const CHART_COLORS = ['#11b6e9', '#ffa536', '#10b981', '#8b5cf6', '#ec4899', '#f59e0b', '#3b82f6', '#06b6d4'];

export default function OrgDesigner() {
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    return (localStorage.getItem('org-designer-mode') as 'ai' | 'traditional') || 'ai';
  });
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2" data-testid="heading-org-designer">Organization Designer</h1>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold" data-testid="text-total-headcount">{totalHeadcount}</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className={totalUkFTE >= 2 ? "border-green-500" : "border-destructive"}>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-green-600 dark:text-green-400" data-testid="text-uk-fte">{totalUkFTE.toFixed(1)}</p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-orange-600 dark:text-orange-400" data-testid="text-salary-cost">£{Math.round(totalSalaryCost / 1000)}k</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-primary" data-testid="text-design-score">{designScore}%</p>
                  ...
                  {getDepartmentData().length > 0 ? (
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={getDepartmentData()}>
                        ...
                        />
                        <Legend />
                        <Bar yAxisId="left" dataKey="headcount" fill="#11b6e9" name="Headcount" />
                        <Bar yAxisId="right" dataKey="budget" fill="#10b981" name="Budget (£k)" />
                        <Bar yAxisId="right" dataKey="allocated" fill="#ffa536" name="Allocated (£k)" />
                      </BarChart>
                    </ResponsiveContainer>
                  ) : (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4 p-3 bg-accent/10 dark:bg-accent/5 rounded">
                          <div>
                            ...
                            <p className="text-2xl font-bold" data-testid={`text-phase-roles-${index}`}>
                          ...
                          <div>
                            ...
                            <p className="text-2xl font-bold" data-testid={`text-phase-cost-${index}`}>
                  ...
                  {getGrowthProjectionData().length > 0 ? (
                    <ResponsiveContainer width="100%" height={300}>
                      <ComposedChart data={getGrowthProjectionData()}>
                        ...
                        />
                        <Legend />
                        <Bar yAxisId="left" dataKey="roles" fill="#11b6e9" name="Planned Roles" />
                        <Line yAxisId="left" dataKey="teamSize" stroke="#10b981" strokeWidth={2} name="Target Size" />
                        <Line yAxisId="right" dataKey="budget" stroke="#ffa536" strokeWidth={2} name="Budget (£k)" />
                      </ComposedChart>
                    </ResponsiveContainer>
                  ) : (
                        ...
                        <AreaChart data={getStructureComplexityData()}>
                          <defs>
                            <linearGradient id="complexityGradient" x1="0" y1="0" x2="0" y2="1">
                              <stop offset="5%" stopColor="#11b6e9" stopOpacity={0.8}/>
                              <stop offset="95%" stopColor="#11b6e9" stopOpacity={0}/>
                            </linearGradient>
                          </defs>
                          <CartesianGrid strokeDasharray="3 3" className="stroke-border" />
                          <XAxis dataKey="phase" className="text-xs" />
                          ...
                          />
                          <Legend />
                          <Area type="monotone" dataKey="complexity" stroke="#11b6e9" fillOpacity={1} fill="url(#complexityGradient)" name="Complexity Score" />
                          <Area type="monotone" dataKey="departments" stroke="#10b981" fill="#10b981" fillOpacity={0.3} name="Departments" />
                          <Area type="monotone" dataKey="roles" stroke="#ffa536" fill="#ffa536" fillOpacity={0.3} name="Roles" />
                        </AreaChart>
                      </ResponsiveContainer>
                    ) : (
                    ...
                    {getStructureComplexityData().length > 0 ? (
                      <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={getStructureComplexityData()}>
                          ...
                          />
                          <Legend />
                          <Line type="monotone" dataKey="headcount" stroke="#11b6e9" strokeWidth={3} name="Total Headcount" dot={{ r: 6 }} />
