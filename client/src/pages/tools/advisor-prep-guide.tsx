...
export default function AdvisorPrepGuide() {
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('advisor-prep-guide-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-xl font-bold mb-2" data-testid="heading-advisor-prep-guide">Advisor Prep Guide</h1>
                    ...
                    <Card className={engagementScore >= 70 ? "border-green-500" : engagementScore >= 50 ? "border-orange-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-engagement-score">{engagementScore}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-onboarding-progress">{completedOnboarding}/{totalOnboarding}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-completed-meetings">{completedMeetings}</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
