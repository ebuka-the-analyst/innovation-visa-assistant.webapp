...
export default function ViabilityChecker() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('viability-checker-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('viability-checker-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                <h1 className="text-xl font-bold mb-2" data-testid="heading-viability-checker">Business Viability Checker</h1>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold text-primary" data-testid="text-viability-grade">{getViabilityGrade()}</p>
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={350}>
                      <RadarChart data={radarData}>
                        ...
                        <Radar name="Your Score" dataKey="score" stroke="#005EB8" fill="#005EB8" fillOpacity={0.6} />
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={350}>
                      <BarChart data={visaCriteriaData}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="score" name="Your Score" fill="#005EB8" />
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={benchmarkData}>
                      ...
                      <Tooltip />
                      <Legend />
                      <Bar dataKey="yourScore" name="Your Score" fill="#005EB8" />
