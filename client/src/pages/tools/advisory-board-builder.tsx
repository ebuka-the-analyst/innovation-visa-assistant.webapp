...
export default function AdvisoryBoardBuilder() {
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('advisory-board-builder-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-xl font-bold mb-2" data-testid="heading-advisory-board-builder">Advisory Board Builder</h1>
                    ...
                    <Card className={onboardedAdvisors >= composition.targetAdvisors ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-board-progress">{onboardedAdvisors}/{composition.targetAdvisors}</p>
                    ...
                    <Card className={boardStrength >= 70 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-board-strength">{boardStrength}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-expertise-coverage">{expertiseCoverage}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-active-advisors">{activeAdvisors}</p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-onboarded">{onboardedAdvisors}</p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-avg-engagement">{avgEngagement}%</p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-equity-allocated">{totalEquityAllocated.toFixed(2)}%</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
