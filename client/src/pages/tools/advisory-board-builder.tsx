...
export default function Advisory Board Builder() {
  return (
    <>
      <AuthHeader />
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2">Advisory Board Builder</h1>
            <p className="text-lg text-muted-foreground">Build and structure your advisory board for credibility</p>
          </div>
