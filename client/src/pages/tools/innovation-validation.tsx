...
export default function InnovationValidation() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('innovation-validation-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('innovation-validation-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
              <div>
                <h1 className="text-xl font-bold mb-2" data-testid="heading-innovation-validation">Innovation Validation</h1>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold text-primary" data-testid="text-completion-rate">{completionRate}%</p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold text-primary" data-testid="text-average-score">{averageScore}/10</p>
                      <div className="flex items-center justify-center gap-2 mt-2">
