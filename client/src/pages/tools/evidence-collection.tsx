...
export default function EvidenceCollection() {
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('evidence-collection-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
  ...
  const generateActionPlan = () => {
    return [
      ...
      {
        week: "Week 3",
        action: "Organize documents by category with clear file naming convention (e.g., 'FIN-001-Bank-Statements-2025.pdf')",
        priority: "High"
      },
      {
        week: "Week 3-4",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-evidence-collection">Evidence Collection Tracker</h1>
                    ...
                    <Card className={completionScore >= 80 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-completion-score">{completionScore}%</p>
                    ...
                    <Card className={criticalScore === 100 ? "border-green-500" : "border-red-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-red-600" data-testid="text-critical-score">{criticalScore}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-green-600" data-testid="text-verified-count">{verified}</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-uploaded-files">{uploadedFiles.length}</p>
                          <FileUploadButton
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Use format: CATEGORY-NUMBER-DESCRIPTION-DATE (e.g., FIN-001-Bank-Statements-2025-11.pdf)</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
