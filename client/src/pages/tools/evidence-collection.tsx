...
const INITIAL_DOCUMENTS: EvidenceDocument[] = [
  ...
  // Financial Records
  { id: 'fin-1', category: 'Financial Records', name: 'Bank Statements (3-6 months)', status: 'not-started', uploadDate: '', priority: 'Critical', endorserRequirement: 'Showing £50,000 available investment funds' },
...
export default function EvidenceCollection() {
  ...
  const getSmartTips = () => {
    ...
    if (financialVerified < 3) {
      tips.push("Financial Records must show clear £50,000 fund availability - ensure bank statements, source of funds, and projections are complete");
    }
...
Financial Records:
- Minimum £50,000 available investment funds
                    ...
                    <div>
                      ...
                      <div className="space-y-3 ml-7">
                        <div className="flex items-start gap-3">
                          <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                          <div>
                            <p className="font-medium">£50,000 Available Funds</p>
                            <p className="text-sm text-muted-foreground">Bank statements (3-6 months) showing minimum investment amount held in regulated financial institution</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          <CheckCircle2 className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
