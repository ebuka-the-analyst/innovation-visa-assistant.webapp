...
export default function EndorserComparison() {
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('endorser-comparison-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-endorser-comparison">Endorser Comparison</h1>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary" data-testid="text-match-score">{bestMatch.matchScore}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-green-600" data-testid="text-success-rate">{bestMatch.successRate}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-total-fees">£{bestMatch.fees.total.toLocaleString()}</p>
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        ...
                        <div className="text-right">
                          <p className="text-lg font-bold text-primary">{endorser.matchScore}%</p>
