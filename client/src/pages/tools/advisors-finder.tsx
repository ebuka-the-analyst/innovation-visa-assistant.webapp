    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-2" data-testid="heading-advisors-finder">Advisors Finder</h1>
                    ...
                    <Card className={committedAdvisors >= advisorNeeds.targetNumber ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold" data-testid="text-committed-advisors">{committedAdvisors}/{advisorNeeds.targetNumber}</p>
                    ...
                    <Card className={portfolioStrength >= 70 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold text-primary" data-testid="text-portfolio-strength">{portfolioStrength}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold" data-testid="text-diversity-score">{diversityScore}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold text-green-600" data-testid="text-outreach-efficiency">{outreachEfficiency}%</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
