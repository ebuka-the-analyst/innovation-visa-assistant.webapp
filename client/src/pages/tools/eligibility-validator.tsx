...
export default function EligibilityValidator() {
  ...
  const meetsFunding = state.fundingAmount >= 50000 && state.hasFundingProof;
  ...
  const checklistItems = [
    ...
    { name: 'Funding £50k+', met: meetsFunding },
  ...
  const totalRequiredFunds = 50000 + totalPersonalFunds;
  ...
  const categoryData = [
    ...
    { category: 'Financial', score: meetsFunding ? 100 : Math.min((state.fundingAmount / 50000) * 100, 99), max: 100 },
  ...
  const getSmartTips = () => {
    ...
    if (state.fundingAmount < 50000) {
      tips.push(`You need £${(50000 - state.fundingAmount).toLocaleString()} more to meet the minimum £50,000 investment requirement`);
    } else if (!state.hasFundingProof) {
  ...
  const generateActionPlan = () => {
    return [
      ...
      { 
        week: "Week 1-2", 
        action: "Secure £50,000 investment funds and obtain 90-day bank statements and verification letters", 
        priority: "Critical" 
      },
      { 
        week: "Week 2", 
...
3. FINANCIAL REQUIREMENT
   ...
   Business Investment Required: £50,000
                      ...
                      <Card className="p-4">
                        <div className="space-y-4">
                          <div>
                            ...
                            />
                            <div className="flex items-center gap-2 mt-2">
                              {state.fundingAmount >= 50000 ? (
                                <CheckCircle2 className="h-4 w-4 text-green-500" />
                              ) : (
                                <XCircle className="h-4 w-4 text-destructive" />
                              )}
                              <span className="text-sm text-muted-foreground">Minimum £50,000 required for business investment</span>
                            </div>
                          </div>
                  ...
                  <div className="space-y-4 text-sm">
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                        ...
                        <li>Investment: £50,000 accessible funds for business</li>
