        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2 gap-4 flex-wrap">
              <h1 className="text-xl font-bold" data-testid="heading-eligibility-validator">Eligibility Validator</h1>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold text-primary mb-2" data-testid="text-eligibility-score">{eligibilityScore}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-criteria-met">{completedItems}/{checklistItems.length}</p>
                        </div>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-lg font-bold" data-testid="text-total-funds">£{totalRequiredFunds.toLocaleString()}</p>
