...
export default function EndorsementReadiness() {
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('endorsement-readiness-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-endorsement-readiness">
                ...
                <Card className={readinessPercentage >= 75 ? "border-green-500" : "border-orange-500"}>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold" data-testid="text-readiness-score">
                        {readinessPercentage}%
                      </p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-center">
                      ...
                      <p className="text-xl font-bold" data-testid="text-requirements-progress">
