...
export default function PitchCoach() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('pitch-coach-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('pitch-coach-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
  ...
  return (
    <ToolAccessGuard requiredTier="enterprise" toolName="Pitch Practice Coach">
      <SEOHead
        ...
        keywords="endorser pitch practice, UK visa interview prep, Innovator Founder Visa presentation, pitch coaching, endorsement interview preparation"
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-xl font-bold mb-2" data-testid="heading-pitch-coach">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold text-primary" data-testid="text-readiness-score">{pitchReadinessScore}%</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold" data-testid="text-practice-sessions">{totalPracticeSessions}</p>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold" data-testid="text-avg-confidence">{avgConfidence}/10</p>
                  <div className="flex items-center justify-center gap-2 mt-2">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center">
                  ...
                  <p className="text-xl font-bold" data-testid="text-qa-prepared">{preparedQA}/{totalQA}</p>
                  <div className="flex items-center justify-center gap-2 mt-2">
