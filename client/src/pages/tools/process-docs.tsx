                    ...
                    <Card className={documentationScore >= 80 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold" data-testid="text-documentation-score">{documentationScore}%</p>
                    ...
                    <Card className={criticalScore >= 90 ? "border-green-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold text-primary" data-testid="text-critical-score">{criticalScore}%</p>
                    ...
                    <Card className={maturityScore >= 60 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold text-purple-600 dark:text-purple-400" data-testid="text-maturity-score">{maturityScore}%</p>
                    ...
                    <Card>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-3xl font-bold text-blue-600 dark:text-blue-400" data-testid="text-avg-completeness">{avgCompleteness}%</p>
