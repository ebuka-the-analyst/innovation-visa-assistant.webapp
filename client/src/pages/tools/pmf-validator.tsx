...
export default function PMFValidator() {
  ...
  const [mode, setMode] = useState<'ai' | 'traditional'>(() => {
    const saved = localStorage.getItem('pmf-validator-mode');
  ...
  useEffect(() => {
    if (!isPaidUser && mode === 'ai') {
      setMode('traditional');
      localStorage.setItem('pmf-validator-mode', 'traditional');
    }
  }, [isPaidUser, mode]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-accent/5 to-primary/5 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-xl font-bold mb-2" data-testid="heading-pmf-validator">Product-Market Fit Validator</h1>
                    ...
                    <Card className={pmfScore >= 70 ? "border-green-500" : pmfScore >= 55 ? "border-yellow-500" : "border-destructive"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className={`text-xl font-bold ${pmfGrade.color}`} data-testid="text-pmf-score">{pmfScore}%</p>
                    ...
                    <Card className={seanEllisScore >= 40 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-sean-ellis">{seanEllisScore}%</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
                            {seanEllisScore >= 40 ? (
                              <CheckCircle2 className="h-5 w-5 text-green-500" />
                            ) : (
                    ...
                    <Card className={retentionRate >= 70 ? "border-green-500" : "border-orange-500"}>
                      <CardContent className="pt-6">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-bold" data-testid="text-retention">{retentionRate}%</p>
                          <div className="flex items-center justify-center gap-2 mt-2">
                            {retentionRate >= 80 ? (
