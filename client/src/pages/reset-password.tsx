...
export default function ResetPassword() {
  ...
  if (isVerifying) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-orange-50 via-blue-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <Card className="w-full max-w-md" data-testid="card-verifying"><div className="flex justify-center pt-5">{typeof window !== "undefined" && /(^|\.)visaassistant\.global$/i.test(window.location.hostname) && <VisaAssistantBrand />}</div>
  ...
  if (!isTokenValid) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-orange-50 via-blue-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
        <Card className="w-full max-w-md" data-testid="card-invalid-token"><div className="flex justify-center pt-5">{typeof window !== "undefined" && /(^|\.)visaassistant\.global$/i.test(window.location.hostname) && <VisaAssistantBrand />}</div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-orange-50 via-blue-50 to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      <Card className="w-full max-w-md" data-testid="card-reset-password"><div className="flex justify-center pt-5">{typeof window !== "undefined" && /(^|\.)visaassistant\.global$/i.test(window.location.hostname) && <VisaAssistantBrand />}</div>
        <CardHeader className="text-center">
