    ...
    const industryTemplates: Record<string, Record<string, string>[]> = {
      fintech: [
        { // FinFlow AI - Cash Flow Forecasting - COMPREHENSIVE
          ...
          competitors: templateNotice + "1. Fluidly (£99/month, 78% accuracy, acquired by Sage). 2. Float (£29/month, manual data entry, no AI). 3. Futrli (£35/month, basic forecasting). 4. Pulse (US-focused, £79/month). 5. Brixx (£15/month, spreadsheet-based). Our advantage: Only AI-powered solution with Open Banking integration at SME price point.",
          competitiveDifferentiation: templateNotice + "94% accuracy vs 73% industry average (validated with 45 businesses). 12-minute setup vs 3-7 days manual. 18-day warning vs 7-day competitors. £60/month vs £99 Fluidly. UK SME-focused vs generic tools. Real-time Open Banking vs CSV uploads.",
          ...
          revenue: templateNotice + "Tiered SaaS: Starter £39/month (basic forecasting), Professional £69/month (AI predictions, alerts), Enterprise £149/month (API access, multi-entity). Add-ons: Custom reports £99/setup, API access £200/month. LTV: £2,160 (36-month retention). CAC: £180. Payback: 3 months. Gross margin: 85%.",
        },
      ...
      services: [
        { // ConsultX - Advisory Platform - COMPREHENSIVE
          ...
          willingnessToPay: templateNotice + "Client pricing: 15% platform fee on project value (vs 20-30% agencies). Consultant: Free listing, 15% of earnings. Premium features: £99/month for priority matching. Average project: £3,200 (range £500-15,000).",
          ...
          revenue: templateNotice + "Platform commission: 15% of project value (from both sides = 7.5% each). Premium listings: £99/month for priority matching. Enterprise: Custom pricing for large clients. Year 1: £63K revenue (15% of £420K GMV). Year 3: £480K (15% of £3.2M).",
        },
