...
export default function QuestionnaireForm({ tier = 'premium' }: { tier?: string }) {
  ...
  const handleEbukaUltimatePlanAutoFill = () => {
    ...
    const demoData: Record<string, string> = {
      ...
      languagesSpoken: templateNotice + "English (Native/Fluent - IELTS 8.5). French (Intermediate - B2 level, lived in Paris 6 months). Spanish (Basic - A2 level, conversational). Mandarin (Beginner - A1 level, currently learning for China market expansion).",
    ...
    const industryTemplates: Record<string, Record<string, string>[]> = {
      fintech: [
        { // FinFlow AI - Cash Flow Forecasting - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "45 beta users including: ABC Accounting Ltd (testimonial: 'Saved us from a £30K shortfall'), XYZ Retail (pilot since August), 3 accounting firms referring clients. 12 paying customers at £60/month.",
          tractionEvidence: templateNotice + "Beta metrics: 45 users, £720 MRR, 94% accuracy validated, 18-day average warning time, 4.7/5 user satisfaction, 85% weekly active usage, 3 case studies documented.",
          uniqueness: templateNotice + "Measurable advantages: (1) 94% forecast accuracy vs 73% industry average. (2) 12-minute setup via Open Banking vs 3-7 day manual entry. (3) 18-day advance shortfall warnings. (4) 40% cheaper than Fluidly (£60 vs £49/month).",
          ...
          dataArchitecture: templateNotice + "Open Banking API integration (TrueLayer, Plaid) for real-time bank feeds. PostgreSQL for transaction storage. Redis for caching predictions. ML pipeline: data ingestion → feature engineering → model inference → dashboard rendering. REST API architecture with webhook notifications.",
          aiMethodology: templateNotice + "Ensemble model: LSTM neural network + XGBoost + ARIMA. Training data: 2.5M anonymized SME transactions. Validation: 80/20 split, backtesting on 12-month historical data. Accuracy: 94.2% (±3% variance). Features: seasonality, payment patterns, invoice aging, industry benchmarks.",
          complianceDesign: templateNotice + "FCA-registered (pending). Open Banking compliant (PSD2). GDPR Article 25 (privacy by design). SOC 2 Type II preparation. Data encrypted at rest (AES-256) and in transit (TLS 1.3). Annual penetration testing. ICO registered.",
          patentStatus: templateNotice + "UK Patent Application GB2412345.6 filed November 2024: 'Machine learning system for SME cash flow prediction using banking transaction patterns'. Defensive publication for ensemble methodology.",
          founderEducation: templateNotice + "MSc Data Science, University of Leeds, 2023 (Distinction). BSc Computer Science, Lagos State University, 2019 (First Class). AWS Solutions Architect certification. Google Cloud Professional Data Engineer.",
          founderWorkHistory: templateNotice + "Senior Data Analyst, HSBC UK (2021-2024): Built fraud detection models saving £2.3M annually. Data Scientist, Monzo (2020-2021): Developed customer churn prediction. Junior Analyst, Deloitte (2019-2020): Financial services consulting.",
          founderAchievements: templateNotice + "Built fraud detection saving HSBC £2.3M/year. Published paper on ML in banking (Journal of Financial Technology, 2023). Led team of 4 data scientists. Presented at FinTech Week London 2023. Mentored 6 junior analysts.",
          relevantProjects: templateNotice + "HSBC Cash Flow Analyzer (internal tool, 50K users). Monzo spending prediction feature. Personal: Open-source cash flow library (2,500 GitHub stars). Leeds dissertation: 'Predictive Analytics for SME Financial Health'.",
          funding: "85000",
          fundingSources: templateNotice + "£45,000 personal savings (bank statements available). £25,000 family investment (loan agreement signed). £15,000 Innovate UK SMART Grant (reference: 10054789). Total: £85,000 runway for 14 months.",
          monthlyProjections: templateNotice + "Year 1: Month 1-3: £0 revenue, £6K/month costs (MVP). Month 4-6: £1.8K MRR, £7K costs. Month 7-12: £4.8K MRR, £9K costs. Year 1 total: £28K revenue, £92K costs. Year 2: £12K MRR by month 24, £180K revenue. Year 3: £35K MRR, £420K revenue, break-even month 28.",
          customerAcquisitionCost: "180",
          lifetimeValue: "2160",
          paybackPeriod: "3",
          detailedCosts: templateNotice + "Development/Cloud: £24K/year. Marketing (content, PPC): £18K/year. Founder salary (Year 2): £36K. Open Banking API fees: £6K/year. Legal/Compliance: £8K. Office/Admin: £4K. Total Year 1: £96K.",
          competitors: templateNotice + "1. Fluidly (£49/month, 78% accuracy, acquired by Sage). 2. Float (£29/month, manual data entry, no AI). 3. Futrli (£35/month, basic forecasting). 4. Pulse (US-focused, £79/month). 5. Brixx (£15/month, spreadsheet-based). Our advantage: Only AI-powered solution with Open Banking integration at SME price point.",
          competitiveDifferentiation: templateNotice + "94% accuracy vs 73% industry average (validated with 45 businesses). 12-minute setup vs 3-7 days manual. 18-day warning vs 7-day competitors. £60/month vs £49 Fluidly. UK SME-focused vs generic tools. Real-time Open Banking vs CSV uploads.",
          customerInterviews: templateNotice + "28 customer discovery interviews (August-October 2024). Key findings: (1) 89% manually forecast in spreadsheets. (2) Average 4 hours/week on cash flow. (3) 67% experienced surprise shortfalls. (4) Willing to pay £50-80/month for accurate forecasting. (5) Trust barrier with AI requires explainability.",
          lettersOfIntent: templateNotice + "3 LOIs signed: ABC Accounting (5 client referrals, £3,600/year value), Manchester SME Network (partnership for 50 members), TechStartup Incubator (10 portfolio companies). Total potential: £18,000 Year 1 revenue.",
          willingnessToPay: templateNotice + "Survey (n=85 SME owners): 72% willing to pay £50-80/month. Beta conversion: 12 of 45 free users converted to £60/month (27% conversion). Churn: 1 of 12 paying customers (8% monthly churn).",
          marketSize: templateNotice + "TAM: 5.9M UK SMEs, £4.1B potential (all financial software). SAM: 890,000 SMEs actively using accounting software, £534M. SOM: Year 1: 500 customers (£360K). Year 3: 5,000 customers (£3.6M). 0.5% SAM penetration realistic.",
          regulatoryRequirements: templateNotice + "FCA registration (Consumer Credit, if offering credit features): 6-9 months, £5K. Open Banking TPP registration: Completed via Yapily partnership. GDPR compliance: ICO registered. SOC 2 Type II: £15K, 6 months. Cyber Essentials Plus: £3K, 2 months.",
          complianceTimeline: templateNotice + "Month 1-2: Cyber Essentials Plus certification. Month 3-6: SOC 2 Type II audit preparation. Month 6-9: FCA registration submission (if credit features added). Month 12: ISO 27001 assessment. Ongoing: Annual penetration testing, GDPR audits.",
          complianceBudget: "28000",
          jobCreation: "8",
          hiringPlan: templateNotice + "Year 1: Founder only + contractors. Year 2: Full-stack Developer (£55K), Customer Success (£35K). Year 3: Sales Manager (£50K + commission), Data Scientist (£60K), Marketing (£40K), Finance (£45K, part-time). Total: 8 employees by end Year 3.",
          specificRegions: templateNotice + "Year 1: London, Manchester, Birmingham (SME density, accounting firm partnerships). Year 2: Leeds, Bristol, Edinburgh, Glasgow. Year 3: All major UK cities. Focus: Tech hubs with high SME concentration.",
          expansion: templateNotice + "Vertical: Expand from general SME to industry-specific (retail, hospitality, professional services with tailored models). Horizontal: Add invoice financing recommendations, credit score features, multi-currency for exporters.",
          internationalPlan: templateNotice + "Year 4: Ireland (similar Open Banking standards, English-speaking). Year 5: Netherlands, Germany (PSD2 compliant). Focus on UK validation and profitability before international expansion. Partnership model for non-English markets.",
          vision: templateNotice + "5-year vision: UK's #1 AI cash flow platform for SMEs. 25,000 customers, £15M ARR, 45 employees. Expanded to invoice financing and credit products. Partnership with major banks. Exit potential: acquisition by accounting software (Sage, Intuit) at 8-10x revenue.",
          targetEndorser: templateNotice + "Primary: Tech Nation (FinTech focus, digital business alignment). Alternative: Innovator International (broader business support). Rationale: Tech Nation has strong FinTech track record, portfolio includes similar B2B SaaS companies, active mentor network in financial services.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Initial pitch and business plan review. (2) Month 6: MVP progress report, customer metrics. (3) Month 12: Annual review, Year 1 achievements. (4) Month 18: Growth update, hiring progress. (5) Month 24: Series A preparation discussion. (6) Month 30: Exit planning, international expansion.",
          experience: templateNotice + "Uniquely qualified: 5 years in UK banking data science (HSBC, Monzo). Built production ML systems serving 50K+ users. Deep understanding of SME financial challenges. Technical expertise: Python, ML, cloud architecture. Domain expertise: UK banking regulations, Open Banking APIs.",
          revenue: templateNotice + "Tiered SaaS: Starter £19/month (basic forecasting), Professional £69/month (AI predictions, alerts), Enterprise £75/month (API access, multi-entity). Add-ons: Custom reports £49/setup, API access £200/month. LTV: £2,160 (36-month retention). CAC: £180. Payback: 3 months. Gross margin: 85%.",
        },
      ...
      ecommerce: [
        { // ShopSmart - AI Recommendations
          ...
          uniqueness: templateNotice + "Measurable results: (1) 8.5% CTR vs 2.5% industry. (2) 23% increase in average order value. (3) 5-minute integration via Shopify/WooCommerce plugins. (4) £49/month vs £500+ competitors.",
      ...
      foodbev: [
        { // GreenBite - Plant-Based Foods - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "45 independent retailers stocking products (list available). 3 restaurant chains in trial (names confidential). Direct-to-consumer via website: 850 repeat customers. Testimonials: 'Best plant-based chicken I've tried' - Sarah M., London.",
          tractionEvidence: templateNotice + "Sales: 12,000 units/month, £48K revenue. Growth: 25% month-on-month. Repeat purchase rate: 67%. Social media: 8,500 followers. Press coverage: The Guardian, BBC Good Food. Great Taste Award 2024 (1 star).",
          ...
          techStack: templateNotice + "Production: Commercial kitchen (HACCP certified), fermentation tanks, packaging line. Suppliers: UK pea protein, natural flavourings. Distribution: 3PL partner. Quality: In-house lab testing.",
          dataArchitecture: templateNotice + "Production process: UK pea protein sourcing → Proprietary fermentation (48-hour process) → Flavour infusion → Forming/shaping → Packaging → Cold chain distribution. Batch tracking: QR codes link to farm origin, production date, nutritional data.",
          aiMethodology: templateNotice + "Not applicable - this is a food manufacturing business. Our innovation is in the proprietary fermentation process that creates a unique texture, not technology/AI. We use standard food production methods with our patented biological process.",
          complianceDesign: templateNotice + "HACCP Level 4 certification (achieved). SALSA (Safe and Local Supplier Approval) - in progress. Allergen management: nut-free facility. Vegan Society trademark application. Organic certification (Soil Association) - planned Year 2. BRCGS Food Safety - planned Year 2.",
          patentStatus: templateNotice + "UK Patent Application GB2412567.8 filed October 2024: 'Fermentation process for plant-based protein texturization'. Trademark: 'GreenBite' registered (UK00003789012). Trade secret: Proprietary flavour formulation (documented, confidential).",
          founderEducation: templateNotice + "MSc Food Science & Technology, University of Reading, 2022 (Distinction). BSc Biochemistry, University of Lagos, 2018 (First Class). HACCP Level 4 certification. Allergen Management certification.",
          founderWorkHistory: templateNotice + "Product Development Manager, Quorn Foods (2022-2024): Led 3 product launches, £2M revenue. Food Scientist, Nestlé R&D (2020-2022): Plant-based research team. Lab Technician, Nigerian Food Research Institute (2018-2020): Protein extraction research.",
          founderAchievements: templateNotice + "Led Quorn product launch generating £2M Year 1 revenue. Published research: 'Fermentation for Plant Protein Improvement' (Food Chemistry Journal, 2023). Won Innovate UK Women in Innovation Award 2023. Developed 12 successful food products in career.",
          relevantProjects: templateNotice + "Quorn: New product line development (£2M revenue). Nestlé: Plant-based chicken alternative R&D. Personal: 18 months developing GreenBite fermentation process. University dissertation: 'Novel Fermentation Methods for Protein Enhancement'.",
          funding: "120000",
          fundingSources: templateNotice + "£50,000 personal savings (bank statements available). £40,000 family investment (formal loan agreement). £30,000 Innovate UK Sustainable Food Grant (reference: SF-2024-0456). Total: £120,000 for equipment and 12-month runway.",
          monthlyProjections: templateNotice + "Year 1: Current - £48K/month revenue, £35K costs. Months 7-12: £75K/month revenue, £50K costs. Year 1 total: £600K revenue, £480K costs. Year 2: £1.2M revenue, 20% net margin. Year 3: £2.5M revenue, 25% margin, break-even Month 8.",
          customerAcquisitionCost: "45",
          lifetimeValue: "280",
          paybackPeriod: "2",
          detailedCosts: templateNotice + "Production facility: £35K/year lease. Ingredients: £15K/month. Packaging: £8K/month. Staff (3 production): £90K/year. Distribution/logistics: £12K/month. Marketing: £3K/month. Compliance/certifications: £15K/year. Total Year 1: £480K.",
          competitors: templateNotice + "1. Beyond Meat (£4.50/pack, US import, limited UK availability). 2. Quorn (£3.50/pack, established brand, egg-based not fully vegan). 3. THIS! (£4.00/pack, VC-funded, broad range). 4. Meatless Farm (£3.80/pack, supermarket focus). 5. Squeaky Bean (£3.50/pack, budget option, basic texture). Our advantage: UK-made, superior taste at competitive price.",
          competitiveDifferentiation: templateNotice + "Blind taste test: 78% preferred GreenBite vs 22% Beyond Meat (n=200). Price: £3.50 vs £4.50 (22% cheaper). 100% UK ingredients (sustainability story). Proprietary texture from fermentation. Great Taste Award validation. Independent retailer relationships.",
          customerInterviews: templateNotice + "32 customer interviews (farmers markets, pop-ups). Key findings: (1) Taste is #1 priority, price #2. (2) 'Made in UK' highly valued for sustainability. (3) Weekly purchase frequency for converted customers. (4) Willing to pay £3-4/pack. (5) Want more variety (currently 3 products).",
          lettersOfIntent: templateNotice + "2 LOIs signed: Whole Foods Market (15 stores, £36K/year potential), Abel & Cole (online delivery partnership, £24K/year potential). 3 restaurant chain trials: Honest Burgers (5 locations), Leon (3 locations), Wagamama (2 locations).",
          willingnessToPay: templateNotice + "Market testing: £3.50/pack optimal price point. 67% repeat purchase rate proves value. Premium positioning vs budget competitors. Subscription box conversion: 23% of website visitors subscribe (£12.99/month, 4 products).",
          marketSize: templateNotice + "TAM: UK plant-based food market £1.1B (2024), growing 18% annually. SAM: Plant-based protein alternatives £340M. SOM: Year 1: £600K (0.18% SAM). Year 3: £2.5M (0.7% SAM). Realistic: UK independent retail + foodservice focus.",
          regulatoryRequirements: templateNotice + "HACCP Level 4: Achieved. SALSA certification: £3K, 3 months. BRCGS Food Safety (required for supermarkets): £8K, 6 months. Organic certification: £2K, 6 months. Vegan trademark: £500, 2 months. Allergen compliance: Ongoing training.",
          complianceTimeline: templateNotice + "Month 1-3: Complete SALSA certification. Month 4-6: Vegan Society trademark approval. Month 6-9: BRCGS Food Safety audit and certification. Month 10-12: Organic certification (Soil Association). Year 2: ISO 22000 food safety management.",
          complianceBudget: "18000",
          jobCreation: "15",
          hiringPlan: templateNotice + "Year 1: 3 production staff (£28K each), 1 sales/marketing (£35K). Year 2: Production Manager (£45K), 4 additional production (£28K), Sales Rep (£32K + commission). Year 3: Operations Director (£55K), Quality Manager (£40K), 3 production. Total: 15 by Year 3.",
          specificRegions: templateNotice + "Year 1: London, South East (health-conscious consumers, premium retailers). Year 2: Manchester, Bristol, Edinburgh (strong vegan scenes). Year 3: National expansion via Ocado, Sainsbury's listing. Production: Current facility Yorkshire, expansion Midlands Year 2.",
          expansion: templateNotice + "Product expansion: Year 1: 3 products. Year 2: 8 products (beef, pork alternatives). Year 3: 15 products (ready meals, sauces). Channel expansion: Independent → Regional supermarkets → National chains → Foodservice (restaurants, universities, hospitals).",
          internationalPlan: templateNotice + "Year 4: Ireland (similar consumer profile, EU access). Year 5: Netherlands, Germany (strong plant-based markets). Strategy: Export initially, local production partnership for scale. Focus: UK profitability and brand strength before international.",
          vision: templateNotice + "5-year vision: UK's leading premium plant-based brand. £15M revenue, 45 employees, national supermarket listings. Known for: UK-made, superior taste, sustainable. Potential exit: acquisition by major food company (Nestlé, Unilever) at 3-4x revenue or private equity growth investment.",
          targetEndorser: templateNotice + "Primary: Innovator International (broad industry coverage, food business expertise). Alternative: UKES (UK Endorsing Service). Rationale: Innovator International has food/FMCG portfolio companies, understands manufacturing businesses, mentor network includes food industry executives.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Business plan and production facility tour. (2) Month 6: Sales progress, retail partnerships update. (3) Month 12: Year 1 review, supermarket listing progress. (4) Month 18: Production expansion plans. (5) Month 24: Team growth, Year 2 financials. (6) Month 30: International expansion strategy.",
          experience: templateNotice + "Uniquely qualified: 6 years food industry R&D (Quorn, Nestlé). Developed 12 commercially successful products. Deep expertise: plant-based protein science, fermentation, food manufacturing. Industry connections: retailer buyers, food service distributors. Proven ability to take products from lab to shelf.",
          revenue: templateNotice + "Product pricing: £3.50-4.50 per pack (250g). Channels: Wholesale to retailers (50% margin), direct-to-consumer website (70% margin), subscription boxes (65% margin). Foodservice: £8-12/kg to restaurants. Target: 60% wholesale, 25% D2C, 15% foodservice. Gross margin: 45%.",
        },
        { // BrewCraft - Artisan Beverages - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "120 pubs/bars (list available). 80 retail stockists (independent bottle shops, delis). Online sales: 2,400 direct customers. Key accounts: BrewDog Bars (12 locations), Bermondsey Beer Mile (6 venues). Testimonials on website.",
          tractionEvidence: templateNotice + "15,000 units/month (£52K revenue). 40% month-on-month growth. Great Taste Award 2024 (2 stars). Featured in: The Drinks Business, Morning Advertiser. Social: 12,000 Instagram followers. 68% repeat purchase rate.",
          ...
          techStack: templateNotice + "Microbrewery (2,000L capacity), cold-extraction system, canning line, quality testing lab. SALSA certification. UK hop suppliers. Yeast bank for proprietary strains.",
          dataArchitecture: templateNotice + "Brewing process: Water treatment → Mashing → Lautering → Boiling → Cold-extraction (proprietary 72-hour process) → Carbonation → Canning. Quality: pH testing, alcohol verification, microbiological testing each batch. Traceability: Batch codes link to ingredients, dates, test results.",
          aiMethodology: templateNotice + "Not applicable - artisan brewing business. Innovation is in proprietary cold-extraction brewing process, not technology. We use traditional craft brewing methods enhanced by our patented low-alcohol extraction technique.",
          complianceDesign: templateNotice + "SALSA certification (achieved). HMRC alcohol duty exemption (0.5% ABV threshold). Trading Standards compliant labelling. Allergen declaration (barley/wheat). Vegan Society certified. BRCGS planned for Year 2 (supermarket requirement).",
          patentStatus: templateNotice + "UK Patent Application GB2411234.5 filed September 2024: 'Cold-extraction method for low-alcohol beer production preserving aromatic compounds'. Trademark: 'BrewCraft' registered. Trade secrets: Proprietary yeast strains, hop combinations documented.",
          founderEducation: templateNotice + "Diploma in Brewing & Distilling, Heriot-Watt University, 2021. BSc Chemistry, University of Manchester, 2018. Cicerone Certified Beer Server. WSET Level 2 Award in Beer.",
          founderWorkHistory: templateNotice + "Head Brewer, Camden Town Brewery (2021-2024): Led innovation team, developed 8 new beers. Assistant Brewer, Beavertown (2019-2021): Production brewing, quality control. Lab Technician, AB InBev (2018-2019): Quality assurance.",
          founderAchievements: templateNotice + "Developed Camden Hells Light (£1.2M Year 1 sales). Won SIBA Regional Champion Beer 2023. Led team of 4 brewers. Published: 'Low-Alcohol Brewing Techniques' (Brewer's Guardian, 2023). Trained 12 junior brewers.",
          relevantProjects: templateNotice + "Camden: Light beer development (£1.2M revenue). Beavertown: Session IPA range. Personal: 3 years developing cold-extraction process (home brewing, then commercial trials). University dissertation: 'Flavour Retention in Dealcoholized Beer'.",
          funding: "95000",
          fundingSources: templateNotice + "£35,000 personal savings. £30,000 family investment. £20,000 Start Up Loans (reference: SUL-2024-8901). £10,000 brewing competition prize money. Total: £95,000 for equipment upgrade and 10-month runway.",
          monthlyProjections: templateNotice + "Year 1: Current £52K/month revenue, £38K costs. Target end Year 1: £85K/month, £55K costs. Year 1 total: £750K revenue, £500K costs. Year 2: £1.5M revenue, 22% margin. Year 3: £3M revenue, 28% margin. Break-even Month 6.",
          customerAcquisitionCost: "35",
          lifetimeValue: "420",
          paybackPeriod: "1",
          detailedCosts: templateNotice + "Brewery lease: £24K/year. Ingredients (hops, malt, yeast): £18K/month. Cans/packaging: £12K/month. Staff (3 brewers): £105K/year. Distribution: £15K/month. Marketing/events: £5K/month. Total Year 1: £500K.",
          competitors: templateNotice + "1. Lucky Saint (market leader, £3.50/can, VC-backed, mainstream taste). 2. Big Drop (£3.00/can, award-winning, limited range). 3. Heineken 0.0 (£1.50/can, mass market, artificial taste). 4. Athletic Brewing (US import, £4.50/can, expensive). 5. Days Brewing (£3.00/can, new entrant). Our advantage: Craft quality, UK-brewed, 0.5% ABV for better taste.",
          competitiveDifferentiation: templateNotice + "Blind taste test: 71% preferred BrewCraft vs 29% Lucky Saint (n=150 craft beer drinkers). Great Taste Award vs no awards for Lucky Saint. 0.5% ABV allows more flavour than 0.0% competitors. UK craft brewery credentials. Premium positioning: £3.50/can vs £1.50 mass market.",
          customerInterviews: templateNotice + "35 interviews at beer festivals, brewery taproom. Findings: (1) 'Tastes like real beer' is main purchase driver. (2) Health-conscious but don't want to compromise. (3) Pay premium for craft quality. (4) Want variety (IPA, Lager, Stout). (5) Value UK provenance.",
          lettersOfIntent: templateNotice + "Partnership agreements: JD Wetherspoon (trial 50 locations, £45K potential), Majestic Wine (20 stores), Waitrose buyer meeting scheduled. Distributor: Matthew Clark (national pub distribution) in negotiation.",
          willingnessToPay: templateNotice + "Optimal price: £3.50/can retail, £3.00 wholesale. Premium positioning justified by taste/awards. Taproom sales: £5/pint. Subscription: 12-can monthly box £36 (24% margin). 68% repeat purchase validates value.",
          marketSize: templateNotice + "TAM: UK beer market £18B. Low/no-alcohol segment £400M (growing 30%/year). SAM: Premium low-alcohol craft beer £80M. SOM: Year 1: £750K (0.9% SAM). Year 3: £3M (3.75% SAM). Realistic given distribution partnerships.",
          regulatoryRequirements: templateNotice + "SALSA certification: Achieved. HMRC duty exemption (0.5% ABV): Confirmed. Trading Standards labelling: Compliant. BRCGS for supermarkets: £8K, 6 months. Allergen management: Documented. Organic (future): Soil Association £2K.",
          complianceTimeline: templateNotice + "Month 1: SALSA renewal. Month 3-6: BRCGS audit preparation. Month 6: BRCGS certification. Month 9: Organic certification application. Month 12: ISO 22000 assessment. Ongoing: HMRC duty compliance, Trading Standards.",
          complianceBudget: "15000",
          jobCreation: "12",
          hiringPlan: templateNotice + "Year 1: Current 3 brewers + founder. Add: Sales Rep (£35K). Year 2: Head Brewer (£50K), 2 production (£30K each), Marketing (£38K). Year 3: Operations Manager (£48K), 3 production. Total: 12 by Year 3.",
          specificRegions: templateNotice + "Year 1: London (craft beer hub), South East. Year 2: Manchester, Bristol, Edinburgh. Year 3: National via Wetherspoon, supermarket listings. Taproom: Bermondsey Beer Mile location Year 2.",
          expansion: templateNotice + "Product: Current 3 beers → Year 2: 6 (add Stout, Wheat, Seasonal). Year 3: 10 + limited editions. Channel: Pubs → Supermarkets → Restaurants → Export. Brand extensions: Merchandise, brewery tours, beer club.",
          internationalPlan: templateNotice + "Year 4: Ireland (Guinness 0.0 competitor, pub culture). Year 5: Benelux (strong craft beer markets). Strategy: Export to specialty importers, then local partnerships. Focus on UK brand building first.",
          vision: templateNotice + "5-year vision: UK's leading craft low-alcohol brewery. £8M revenue, 25 employees. Known for: Uncompromising taste, craft credentials, innovation. Flagship taproom in London. Potential: Acquisition by major brewer (AB InBev, Molson Coors) or private equity growth.",
          targetEndorser: templateNotice + "Primary: Innovator International (manufacturing/FMCG expertise). Alternative: Tech Nation (if highlighting e-commerce/D2C technology). Rationale: Innovator International understands product businesses, has food/beverage portfolio, manufacturing mentor network.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Brewery tour, business plan review. (2) Month 6: Sales/distribution progress. (3) Month 12: Year 1 review, supermarket discussions. (4) Month 18: Expansion plans, new product launches. (5) Month 24: Team growth, export strategy. (6) Month 30: Brand valuation, exit options.",
          experience: templateNotice + "Uniquely qualified: 6 years professional brewing (Camden, Beavertown). Developed award-winning beers generating £1M+ revenue. Technical: brewing science, flavour chemistry, quality control. Industry connections: pub chains, distributors, retailers. Passion: Founded home brewing club with 50 members.",
          revenue: templateNotice + "Pricing: £3.50/can retail, £2.40 wholesale, £3.00 D2C. Channels: 50% wholesale to pubs/retailers, 30% D2C website, 20% taproom. Subscription: 12-can box £36/month. Gross margin: 52% wholesale, 68% D2C. Target: £750K Year 1, £3M Year 3.",
        },
        { // FreshPack - Sustainable Packaging - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "8 food manufacturers expressed interest (emails available). 3 pilot agreements signed: UK organic food brand (150K units trial), meal prep company (75K units), ready meals manufacturer (200K units). Letters of intent total value: £85K.",
          tractionEvidence: templateNotice + "Prototype validation: 45-day shelf life proven (vs 30 days plastic). 3 signed pilot agreements. Innovate UK grant application (£75K) shortlisted. Featured: Packaging News, The Grocer. 2 VC meetings scheduled.",
          ...
          techStack: templateNotice + "R&D lab, seaweed processing equipment, film extrusion machinery. Key partners: Scottish seaweed farms, food science consultants. Production: Contract manufacturing partner identified.",
          dataArchitecture: templateNotice + "Production process: Seaweed harvesting (Scottish farms) → Cleaning/processing → Biopolymer extraction → Film formation → Coating application → Converting (bags, wraps, trays). Quality: Shelf-life testing, compostability certification, food contact testing.",
          aiMethodology: templateNotice + "Not applicable - materials science/manufacturing business. Our innovation is in the seaweed-based biopolymer formulation and production process, not technology. We use standard food packaging production methods with our patented bio-material.",
          complianceDesign: templateNotice + "Food contact materials (FCM) compliance: EU 10/2011. Compostability: EN 13432 standard (testing in progress). BRCGS Packaging certification: Planned for production facility. Home compostability: OK Compost Home certification target.",
          patentStatus: templateNotice + "UK Patent Application GB2413456.9 filed November 2024: 'Seaweed-derived biopolymer film for food packaging with extended shelf-life properties'. Trade secret: Proprietary coating formulation. Design registration: Packaging shapes pending.",
          founderEducation: templateNotice + "PhD Materials Science, Imperial College London, 2023 (Bio-based polymers thesis). MEng Chemical Engineering, University of Cambridge, 2019 (First Class). RSC Chartered Chemist status.",
          founderWorkHistory: templateNotice + "R&D Scientist, BASF Packaging (2023-2024): Developed sustainable films. Research Assistant, Imperial College (2019-2023): PhD on seaweed biopolymers. Intern, Unilever R&D (Summer 2018): Sustainable packaging projects.",
          founderAchievements: templateNotice + "PhD research cited 12 times. BASF: Contributed to 2 patent applications. Winner: Royal Society of Chemistry Young Researcher Award 2023. Published 5 peer-reviewed papers. Presented at 3 international conferences.",
          relevantProjects: templateNotice + "Imperial PhD: 4 years developing seaweed polymer technology. BASF: Bio-based film development. Publications: 'Novel Seaweed Biopolymers for Food Packaging' (Green Chemistry, 2023). Pilot: 3 food company packaging trials.",
          funding: "180000",
          fundingSources: templateNotice + "£50,000 personal savings. £40,000 family investment. £75,000 Innovate UK Sustainable Plastics Grant (application shortlisted). £15,000 climate tech competition prize. Total: £180,000 for pilot production.",
          monthlyProjections: templateNotice + "Year 1: Pre-revenue (R&D, pilots). Months 10-12: First sales £15K/month. Year 1: £45K revenue, £170K costs (investment phase). Year 2: £480K revenue (pilots convert to orders). Year 3: £1.5M revenue, break-even Month 30.",
          customerAcquisitionCost: "2500",
          lifetimeValue: "45000",
          paybackPeriod: "2",
          detailedCosts: templateNotice + "R&D/prototyping: £40K. Lab equipment: £25K. Contract manufacturing setup: £35K. Certifications: £20K. Staff (2 scientists): £90K/year. Materials testing: £15K. Marketing/sales: £10K. Total Year 1: £170K.",
          competitors: templateNotice + "1. Novamont/Mater-Bi (Italian, corn-based, 2x price of plastic). 2. TIPA (Israeli, home compostable, premium price). 3. Notpla (UK seaweed, limited to sachets/coatings). 4. BioPak (Australian, sugarcane, import costs). 5. Vegware (UK, plant-based, not food contact films). Our advantage: UK seaweed supply, competitive pricing at scale, extended shelf-life.",
          competitiveDifferentiation: templateNotice + "45-day shelf life vs 30 days plastic (lab validated). UK seaweed sourcing (sustainability story, supply security). Target: Same price as plastic at 10M+ units. Home compostable vs industrial-only competitors. Focus: Food films (underserved by competitors).",
          customerInterviews: templateNotice + "22 interviews with food packaging buyers. Findings: (1) Sustainability is boardroom priority but cost is barrier. (2) Will pay 10-20% premium maximum. (3) Shelf-life critical for fresh foods. (4) 'Made in UK' sustainability story valuable. (5) Need industrial-scale proof.",
          lettersOfIntent: templateNotice + "3 pilot agreements signed: Organic food brand (150K units, £12K), Meal prep company (75K units, £6K), Ready meals manufacturer (200K units, £15K). Conditional orders: £85K upon successful pilots and production scale-up.",
          willingnessToPay: templateNotice + "Target pricing: 15% above plastic initially, parity at scale. Pilot pricing: £0.08/unit vs £0.07/unit plastic. Customer feedback: 8/10 buyers accept 15% premium for genuine sustainability. Volume discounts: 20% at 1M+ units.",
          marketSize: templateNotice + "TAM: UK food packaging £8B. Sustainable packaging £960M (12%, growing 20%/year). SAM: Flexible food films/wraps £240M. SOM: Year 1: £45K (pilots). Year 3: £1.5M (0.6% SAM). Realistic given production ramp-up timeline.",
          regulatoryRequirements: templateNotice + "Food contact materials (FCM): EU 10/2011 testing £15K. EN 13432 compostability: £8K, 6 months testing. OK Compost Home: £5K. BRCGS Packaging: £10K. REACH compliance: Confirmed. Novel food contact material notification.",
          complianceTimeline: templateNotice + "Month 1-6: FCM testing and certification. Month 3-9: EN 13432 composting trials. Month 6-12: OK Compost Home certification. Month 12-18: BRCGS Packaging for production facility. Ongoing: Batch testing for each production run.",
          complianceBudget: "45000",
          jobCreation: "18",
          hiringPlan: templateNotice + "Year 1: Founder + 1 Materials Scientist (£45K). Year 2: Production Manager (£50K), 3 production operators (£28K each), Sales (£40K). Year 3: Quality Manager (£42K), 8 production staff, R&D scientist (£48K). Total: 18 by Year 3.",
          specificRegions: templateNotice + "Year 1: Production pilot in Scotland (near seaweed supply). Year 2: Main facility Midlands (logistics hub). Sales: London, South East (food manufacturer HQs). Year 3: National distribution from central facility.",
          expansion: templateNotice + "Product: Year 1: Films/wraps. Year 2: Trays, punnets. Year 3: Full range including rigid containers. Vertical: Food → Cosmetics → Pharma (higher margins). Technology licensing to international manufacturers.",
          internationalPlan: templateNotice + "Year 4: EU (single market, similar regulations). Year 5: North America (growing sustainable packaging demand). Strategy: Technology licensing model for international (avoid logistics complexity). Focus: UK market leadership first.",
          vision: templateNotice + "5-year vision: UK's leading seaweed packaging company. £12M revenue, 45 employees. Full range: films, trays, rigid packaging. Known for: Genuine sustainability, competitive pricing. Exit: Acquisition by major packaging company (Amcor, Berry) or materials company (BASF, Dow).",
          targetEndorser: templateNotice + "Primary: Tech Nation (deep-tech, climate focus). Alternative: Innovator International (manufacturing expertise). Rationale: Tech Nation values science-based innovation, has climate-tech portfolio, provides access to VC network for capital-intensive scaling.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Technology review, patent strategy. (2) Month 6: Pilot results, certification progress. (3) Month 12: Production scale-up, customer conversions. (4) Month 18: Funding round support. (5) Month 24: Market expansion, new products. (6) Month 30: International licensing, exit preparation.",
          experience: templateNotice + "Uniquely qualified: PhD in seaweed biopolymers (4 years research). Industry R&D experience (BASF). Published researcher with 5 papers, 12 citations. Technical: polymer science, food packaging, sustainability certifications. Network: packaging industry contacts, seaweed farming partnerships.",
          revenue: templateNotice + "B2B pricing: £0.08/unit films (vs £0.07 plastic). Volume tiers: 100K units (full price), 500K (10% discount), 1M+ (20% discount). Gross margin: 45% at scale. Revenue model: Product sales + potential technology licensing Year 4+. Target: Break-even at 15M units/year production.",
        },
      ],
      manufacturing: [
        { // EcoMake - Sustainable Manufacturing - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "35 B2B customers: 15 local councils (park benches, playground equipment), 12 schools (outdoor seating), 8 commercial properties. Key accounts: Manchester City Council (£28K order), Leeds Schools Partnership (£18K). Testimonials available.",
          tractionEvidence: templateNotice + "£180K revenue Year 1. 35 repeat customers. Average order value: £5,100. 85% customer retention. Featured: The Guardian sustainability section, Construction News. 3 industry awards. ISO 14001 and CE certified.",
          ...
          techStack: templateNotice + "Manufacturing: Injection moulding, extrusion lines, recycling shredders. Quality: Tensile testing, UV weathering chamber. Certifications: ISO 14001, CE marking. ERP: Manufacturing software for order tracking.",
          dataArchitecture: templateNotice + "Production: Plastic waste collection → Sorting/cleaning → Shredding → Reinforcement additive mixing → Extrusion/moulding → Quality testing → Finishing → Dispatch. Traceability: Each product tagged with waste source, production batch, test results.",
          aiMethodology: templateNotice + "Not applicable - manufacturing business. Our innovation is in the proprietary reinforcement formula that strengthens recycled plastic, not technology/AI. We use advanced material science with our patented additive blend.",
          complianceDesign: templateNotice + "ISO 14001 Environmental Management (achieved). ISO 9001 Quality Management (achieved). CE marking for playground equipment. EN 1176 playground safety standards. Waste Carrier Licence. Environmental Permit for processing.",
          patentStatus: templateNotice + "UK Patent GB2410234.7: 'Reinforcement additive for recycled polymer enhancement'. Filed March 2024. Trade secrets: Exact additive ratios documented. Trademark: 'EcoMake' registered. Design registrations: 8 product designs protected.",
          founderEducation: templateNotice + "MEng Materials Engineering, University of Sheffield, 2020 (First Class). BSc Mechanical Engineering, University of Ibadan, 2016 (First Class). Six Sigma Green Belt. Health & Safety Management certification.",
          founderWorkHistory: templateNotice + "Production Manager, Berry Plastics UK (2021-2024): Managed 40-person facility, £8M output. Process Engineer, DS Smith (2020-2021): Packaging innovation. Engineer, Dangote Industries (2016-2020): Large-scale manufacturing.",
          founderAchievements: templateNotice + "Reduced Berry Plastics waste by 35% (£400K annual savings). Led facility to ISO 14001 certification. Managed 40-person production team. Published: 'Recycled Polymer Reinforcement' (Plastics Engineering, 2023). Won Sustainability in Manufacturing Award 2023.",
          relevantProjects: templateNotice + "Berry Plastics: Waste reduction initiative (£400K savings). DS Smith: Recycled content packaging development. Personal: 2 years developing reinforcement formula. Sheffield dissertation: 'Mechanical Properties of Recycled Thermoplastics'.",
          funding: "150000",
          fundingSources: templateNotice + "£60,000 personal savings. £50,000 family investment. £40,000 WRAP (Waste & Resources Action Programme) Grant (reference: WRAP-2024-0892). Total: £150,000 for equipment and working capital.",
          monthlyProjections: templateNotice + "Year 1: £15K/month revenue (current), £12K costs. Year 2: £40K/month revenue, £28K costs. Year 3: £80K/month revenue, £55K costs. Year 1 total: £180K revenue, £144K costs. Year 3: £960K revenue, break-even Month 10.",
          customerAcquisitionCost: "850",
          lifetimeValue: "25500",
          paybackPeriod: "1",
          detailedCosts: templateNotice + "Factory lease: £36K/year. Raw materials (plastic waste): £48K/year. Equipment maintenance: £18K/year. Staff (5 production): £145K/year. Utilities: £24K/year. Certifications: £8K/year. Marketing: £12K/year. Total Year 1: £144K.",
          competitors: templateNotice + "1. Kedel (established recycled plastic, premium pricing). 2. British Recycled Plastic (limited product range). 3. Enviropol (strong council relationships). 4. Marmax Products (focus on garden). 5. Plastic Lumber Company (imported products). Our advantage: Superior strength, competitive pricing, 50-year warranty.",
          competitiveDifferentiation: templateNotice + "Material testing: 95% virgin plastic strength (vs 60% competitors). 50-year warranty (vs 25-year industry standard). 20% lower pricing through efficiency. Full circularity (take back old products). UK manufacturing (vs imports). ISO 14001 certified.",
          customerInterviews: templateNotice + "25 interviews with council procurement officers and facilities managers. Findings: (1) Sustainability is council priority. (2) Total cost of ownership matters (long warranty). (3) UK manufacturing preferred for carbon footprint. (4) Price competitive with virgin plastic needed. (5) Testimonials important for public procurement.",
          lettersOfIntent: templateNotice + "3 LOIs signed: Birmingham City Council (£45K, park furniture), London Borough of Camden (£32K, school playground), University of Leeds (£18K, campus seating). Framework agreements in discussion with 5 additional councils.",
          willingnessToPay: templateNotice + "Council procurement: Competitive with virgin plastic alternatives. Premium justified by 50-year warranty, sustainability credentials. Average order: £5,100. Framework pricing: 10% discount for multi-year agreements.",
          marketSize: templateNotice + "TAM: UK outdoor furniture/street furniture £800M. SAM: Public sector sustainable products £180M. SOM: Year 1: £180K (0.1% SAM). Year 3: £960K (0.5% SAM). Realistic given B2B sales cycle and council procurement processes.",
          regulatoryRequirements: templateNotice + "ISO 14001: Achieved. ISO 9001: Achieved. CE marking: Achieved. EN 1176 (playground): Per product testing £2K. Waste Carrier Licence: £154. Environmental Permit: Achieved. CHAS/SafeContractor for council work.",
          complianceTimeline: templateNotice + "Month 1: CHAS accreditation (council contractor requirement). Month 3: SafeContractor. Month 6: ISO 45001 (occupational health). Month 12: Carbon Trust certification. Ongoing: EN 1176 testing for each new playground product.",
          complianceBudget: "22000",
          jobCreation: "18",
          hiringPlan: templateNotice + "Year 1: Current 5 production + founder. Add: Sales Manager (£42K). Year 2: 4 additional production (£28K each), Quality Manager (£38K). Year 3: Operations Director (£55K), 5 production staff, Admin (£28K). Total: 18 by Year 3.",
          specificRegions: templateNotice + "Year 1: North of England (factory base Yorkshire). Year 2: Midlands, Scotland (strong council demand). Year 3: National coverage. Factory expansion: Second facility Midlands Year 3 to serve southern councils.",
          expansion: templateNotice + "Products: Year 1: Benches, tables. Year 2: Playground equipment, planters. Year 3: Full street furniture range. Sectors: Councils → Schools → Commercial property → Retail → Hospitality. Revenue: B2B public sector → B2B private sector.",
          internationalPlan: templateNotice + "Year 4: Ireland (EU access, similar procurement processes). Year 5: Benelux, Nordics (strong sustainability focus). Strategy: Direct sales initially, distributor partnerships for scale. Focus: UK market leadership before international.",
          vision: templateNotice + "5-year vision: UK's leading recycled plastic products company. £5M revenue, 45 employees, national distribution. Known for: Uncompromising quality, true circularity, council trusted. Exit potential: Acquisition by construction materials company or private equity growth.",
          ...
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Factory tour, business plan review. (2) Month 6: Sales progress, new products. (3) Month 12: Year 1 review, expansion plans. (4) Month 18: Second facility planning. (5) Month 24: Team growth, national coverage. (6) Month 30: Export strategy, exit options.",
          experience: templateNotice + "Uniquely qualified: 8 years manufacturing experience (Berry, DS Smith, Dangote). Led 40-person facility. Deep expertise: plastics processing, quality systems, sustainability. Proven: 35% waste reduction delivering £400K savings. Industry connections: procurement networks.",
          revenue: templateNotice + "B2B pricing: £500-15,000 per order. Product margins: 35-45%. Payment: 30-day terms for councils (creditworthy). Framework agreements: Annual committed volumes. Target: 85% public sector, 15% private. Year 1: £180K. Year 3: £960K.",
        },
        { // SmartBuild - Construction Innovation - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "3 housing associations (12 units delivered). 2 commercial clients (office pods). Key accounts: Midland Housing Association (8 units, £280K), Community Housing Trust (4 units, £140K). 4.8/5 customer satisfaction. References available.",
          tractionEvidence: templateNotice + "12 units delivered, £420K revenue. Average build time: 8 weeks (vs 6 months traditional). Customer satisfaction: 4.8/5. Press: Construction News, Building Magazine. Pipeline: £800K in proposals. NHBC warranty provider approved.",
          ...
          techStack: templateNotice + "Factory: CNC cutting, modular assembly line, quality testing. Materials: Timber frame, SIPs panels, triple glazing. Transport: Oversized load logistics. Design: BIM software for customisation.",
          dataArchitecture: templateNotice + "Production: Design (BIM) → CNC cutting → Modular assembly → MEP fit-out → Quality inspection → Transport → On-site installation → Commissioning. Tracking: Project management software links design, production, installation, warranties.",
          aiMethodology: templateNotice + "Not applicable - construction/manufacturing business. Innovation is in factory production methods and modular design system, not technology/AI. We use advanced construction techniques with our proprietary modular system.",
          complianceDesign: templateNotice + "NHBC warranty (achieved - key for housing associations). Building Regulations Part L (EPC A standard). BOPAS certification (pending - mortgage lender acceptability). Structural warranty insurance. CDM Regulations compliant.",
          patentStatus: templateNotice + "UK Design Registration: Modular connection system. Trade secrets: Proprietary panel specifications, assembly sequences documented. Trademark: 'SmartBuild' registered. No patents filed - method relies on know-how and efficiency.",
          founderEducation: templateNotice + "MSc Construction Management, Loughborough University, 2019 (Distinction). BEng Civil Engineering, University of Lagos, 2015 (First Class). CIOB Member. SMSTS Site Management certification.",
          founderWorkHistory: templateNotice + "Project Manager, Laing O'Rourke (2019-2024): Delivered £45M modular hospital project. Site Manager, Berkeley Homes (2017-2019): Residential developments. Graduate Engineer, Julius Berger Nigeria (2015-2017): Infrastructure projects.",
          founderAchievements: templateNotice + "Led £45M modular hospital project (on time, under budget). Managed teams of 80+ workers. Introduced lean construction methods saving 15% on project costs. CIOB Young Achiever Award finalist 2023. Delivered 500+ residential units across career.",
          relevantProjects: templateNotice + "Laing O'Rourke: Modular hospital building (£45M, 18 months). Berkeley: Modular bathroom pods (200 units). Personal: SmartBuild pilot with 12 homes. Loughborough dissertation: 'Off-site Construction Efficiency in UK Housing'.",
          funding: "280000",
          fundingSources: templateNotice + "£80,000 personal savings. £100,000 family investment (equity). £50,000 Start Up Loans. £50,000 Homes England Innovation Grant (reference: HE-2024-3456). Total: £280,000 for factory setup and working capital.",
          monthlyProjections: templateNotice + "Year 1: £35K/month revenue (current), £28K costs. Year 2: £120K/month revenue, £85K costs. Year 3: £250K/month revenue, £170K costs. Year 1 total: £420K revenue, £336K costs. Year 3: £3M revenue, break-even Month 14.",
          customerAcquisitionCost: "8500",
          lifetimeValue: "180000",
          paybackPeriod: "2",
          detailedCosts: templateNotice + "Factory lease: £60K/year. Equipment: £40K depreciation. Materials: £25K/unit. Staff (8 production): £280K/year. Transport: £8K/unit. Certifications: £15K/year. Sales/marketing: £24K/year. Total Year 1: £336K.",
          competitors: templateNotice + "1. Legal & General Modular (large-scale, £200M+ invested). 2. Ilke Homes (VC-backed, volume focused). 3. TopHat (technology-driven, premium). 4. Berkeley Modular (developer-owned). 5. Swan Housing (housing association owned). Our advantage: Nimble, cost-efficient, housing association specialist.",
          competitiveDifferentiation: templateNotice + "Build time: 8 weeks vs 6 months traditional. Cost: £1,500/sqm vs £2,000/sqm (25% cheaper). Waste: 5% vs 35% traditional. EPC A standard (vs EPC C industry average). NHBC warranty for mortgage lender acceptance. Housing association focus (vs developer focus of competitors).",
          customerInterviews: templateNotice + "18 interviews with housing association development directors. Findings: (1) Speed critical for grant funding deadlines. (2) Cost per unit is key metric. (3) Mortgage lender acceptability essential. (4) Quality concerns about modular (need references). (5) Local authority relationships important for planning.",
          lettersOfIntent: templateNotice + "2 LOIs signed: Regional Housing Association (20 units, £700K, subject to planning), Community Land Trust (8 units, £280K). Pipeline discussions: 5 additional housing associations representing £2.4M potential Year 2-3.",
          willingnessToPay: templateNotice + "Housing association pricing: £35K per 2-bed unit (vs £45K traditional equivalent). Development agreements: Milestone payments (30% deposit, 40% production, 30% installation). Price premium justified by speed to meet Homes England grant deadlines.",
          marketSize: templateNotice + "TAM: UK new housing £40B annually. SAM: Affordable housing (housing associations) £6B. SOM: Year 1: £420K (0.007% SAM). Year 3: £3M (0.05% SAM). Conservative given factory capacity constraints.",
          regulatoryRequirements: templateNotice + "NHBC warranty: Achieved. BOPAS certification: £25K, 6 months (critical for mortgage lender acceptance). Building Control type approval: £15K. CDM compliance: Ongoing. Structural warranty insurance: £20K/year.",
          complianceTimeline: templateNotice + "Month 1-6: BOPAS certification (mortgage lender acceptability). Month 6-12: Building Control type approval (streamlines future projects). Month 12-18: ISO 9001 quality management. Year 2: ISO 14001 environmental management.",
          complianceBudget: "65000",
          jobCreation: "25",
          hiringPlan: templateNotice + "Year 1: 8 factory staff + founder. Add: Sales Director (£60K). Year 2: Production Manager (£50K), 6 factory (£30K each), Site Team Lead (£45K). Year 3: Operations Director (£65K), 8 additional factory, Site team (4). Total: 25 by Year 3.",
          specificRegions: templateNotice + "Year 1: Midlands (factory base), North West (housing need). Year 2: Yorkshire, North East. Year 3: National. Strategy: Focus on regions with housing association partnerships and strong affordable housing demand.",
          expansion: templateNotice + "Products: Year 1: 2-bed homes. Year 2: Add 1-bed, 3-bed, apartments. Year 3: Commercial (office pods, retail). Sectors: Housing associations → Local authorities → Private developers → Commercial. Scale: 50 units/year → 150 units/year.",
          internationalPlan: templateNotice + "Year 4: Ireland (housing crisis, similar regulations). Year 5: Export modular systems to Middle East (high demand, premium margins). Strategy: UK housing focus first, international licensing/JV model. Focus on UK profitability before expansion.",
          vision: templateNotice + "5-year vision: UK's leading modular affordable housing provider. 300 homes/year, £15M revenue, 60 employees. Known for: Speed, quality, sustainability, housing association trusted. Exit: Acquisition by major housebuilder or private equity growth investment.",
          targetEndorser: templateNotice + "Primary: Innovator International (construction expertise, manufacturing focus). Alternative: GEP (high-growth potential). Rationale: Innovator International has construction portfolio, understands capital-intensive businesses, mentor network includes property developers.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Factory tour, housing association pipeline review. (2) Month 6: BOPAS progress, first repeat orders. (3) Month 12: Year 1 delivery, expansion plans. (4) Month 18: Factory capacity increase. (5) Month 24: Team growth, new product lines. (6) Month 30: National expansion, exit planning.",
          experience: templateNotice + "Uniquely qualified: 9 years construction experience including £45M modular hospital project. Led teams of 80+. Deep expertise: modular construction, project management, housing regulations. Industry connections: housing associations, Homes England. Proven delivery of 500+ residential units.",
          revenue: templateNotice + "Product pricing: £35K per 2-bed unit (turnkey). Development margin: 25-30%. Payment: Staged (30/40/30). Framework agreements with housing associations for volume discounts. Add-ons: Design customisation, site works. Target: Year 1 £420K, Year 3 £3M.",
        },
      ...
      creative: [
        { // StoryStream - Content Platform - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "450 active creators across categories: 180 lifestyle, 120 education, 90 gaming, 60 business. Top creators: @FinanceWithSam (45K subscribers, £8K/month), @CookingWithAisha (32K, £5K/month). Creator testimonials available.",
          tractionEvidence: templateNotice + "£85K monthly transaction volume (GMV). 450 creators, 28K paying subscribers across platform. Average creator revenue: £680/month (+40% vs YouTube). Creator retention: 89%. Platform commission: £12.75K/month revenue.",
          ...
          techStack: templateNotice + "Platform: React, Node.js, PostgreSQL. Payments: Stripe Connect. Video: Mux streaming. Analytics: Custom dashboard. Email: SendGrid integration. Mobile: React Native app.",
          dataArchitecture: templateNotice + "Creator flow: Content upload → Video processing (Mux) → Paywall configuration → Subscriber management → Payment split (Stripe Connect). Analytics: Views, engagement, revenue, subscriber behaviour. Integrations: YouTube/TikTok analytics import.",
          aiMethodology: templateNotice + "Not applicable - SaaS platform for creators. Our innovation is in the business model (creator-first revenue share) and integrated tools, not AI technology. We use standard web development practices with payment infrastructure focus.",
          complianceDesign: templateNotice + "GDPR compliant (data processing, consent management). PCI DSS via Stripe. UK GDPR representative appointed. Cookies policy. Age-gating for adult content creators. Content moderation policy.",
          patentStatus: templateNotice + "No patents filed - business model innovation rather than technology. Trademark: 'StoryStream' registered (UK00003890123). Trade secrets: Sponsorship matching algorithm documented confidentially.",
          founderEducation: templateNotice + "MA Digital Media, Goldsmiths University, 2021. BA Media Studies, University of Westminster, 2018 (First Class). Google Analytics certified. HubSpot Content Marketing certified.",
          founderWorkHistory: templateNotice + "Creator Partnerships Manager, Patreon UK (2021-2024): Managed 500+ creator accounts, £2M+ revenue portfolio. Content Manager, Vice UK (2019-2021): Audience growth strategy. Freelance Content Creator (2016-2019): 50K YouTube subscribers.",
          founderAchievements: templateNotice + "Grew Patreon UK creator portfolio to £2M+ ARR. Personally built YouTube channel to 50K subscribers. Led Vice UK TikTok launch (1M followers in 6 months). Speaker at VidCon London 2023. Mentored 30+ creators.",
          relevantProjects: templateNotice + "Patreon: UK creator growth strategy (£2M ARR portfolio). Vice: Social media strategy, TikTok launch. Personal: YouTube channel (50K subs, £3K/month peak). Side project: Creator newsletter (8K subscribers).",
          funding: "75000",
          fundingSources: templateNotice + "£35,000 personal savings. £25,000 family investment. £15,000 Creative Industries Fund grant (reference: CIF-2024-1234). Total: £75,000 for platform development and marketing.",
          monthlyProjections: templateNotice + "Year 1: £12.75K/month commission revenue, £9K costs. Year 2: £35K/month revenue (1,200 creators), £25K costs. Year 3: £85K/month revenue (3,000 creators), £55K costs. Break-even Month 6. Year 3: £1M revenue.",
          customerAcquisitionCost: "45",
          lifetimeValue: "1080",
          paybackPeriod: "1",
          detailedCosts: templateNotice + "Platform hosting/infrastructure: £3K/month. Video processing (Mux): £2K/month. Payment processing: 0.5% of GMV. Marketing: £2K/month. Staff (Year 2): £60K/year. Customer support: £1K/month. Total Year 1: £108K.",
          competitors: templateNotice + "1. Patreon (established, 5-12% fees, limited video). 2. Ko-fi (hobbyist focus, 0% fees but limited features). 3. YouTube Memberships (45% platform cut). 4. Gumroad (digital products, not subscription). 5. Memberful (WordPress-focused). Our advantage: Creator-first economics, integrated video, UK focus.",
          competitiveDifferentiation: templateNotice + "Creator economics: 85% revenue share (vs 55% YouTube, 88-95% Patreon). Integrated video streaming (vs Patreon's links-only). UK-focused support and community. Sponsorship marketplace (unique). Analytics dashboard aggregating all platforms.",
          customerInterviews: templateNotice + "45 creator interviews (10K-500K follower range). Findings: (1) Revenue share is pain point. (2) Audience ownership critical. (3) Want one dashboard for all platforms. (4) Sponsorships hard to find as mid-tier creator. (5) Will switch for 10%+ revenue increase.",
          lettersOfIntent: templateNotice + "Creator commitments: 15 creators (combined 800K audience) agreed to migrate upon launch features. Agency partnership: Talent management agency (50 creators) in discussion. Brand partnerships: 3 sponsors interested in marketplace.",
          willingnessToPay: templateNotice + "Creator pricing: 15% platform fee (accepted by 89% in survey). Subscriber pricing: £3-15/month (creator-set). Additional revenue: Sponsorship marketplace 20% fee. Premium analytics: £15/month optional. Conversion: 6% subscriber rate from free audience.",
          marketSize: templateNotice + "TAM: Global creator economy £80B. SAM: UK creator monetisation platforms £400M. SOM: Year 1: £150K (450 creators × £27/month average commission). Year 3: £1M (3,000 creators). 0.25% SAM penetration Year 3.",
          regulatoryRequirements: templateNotice + "GDPR: Data processing agreements, privacy policy. PCI DSS: Via Stripe (Level 1). Digital Services Act: Content moderation. Age verification: For adult content creators. ICO registration: Completed.",
          complianceTimeline: templateNotice + "Month 1: ICO registration complete. Month 3: GDPR audit and documentation. Month 6: Content moderation policy and tools. Month 12: ISO 27001 assessment (enterprise clients). Ongoing: Privacy policy updates.",
          complianceBudget: "12000",
          jobCreation: "12",
          hiringPlan: templateNotice + "Year 1: Founder + part-time support (contractors). Year 2: Full-stack Developer (£55K), Creator Success Manager (£35K), Marketing (£40K). Year 3: CTO (£70K), 2 developers, Sales (£45K), Support (2 × £28K). Total: 12 by Year 3.",
          specificRegions: templateNotice + "Year 1: UK creators (English-speaking, regulatory familiarity). Year 2: Ireland, Australia (similar markets). Year 3: US expansion (largest creator market). Focus: London, Manchester, Bristol (creator hubs).",
          expansion: templateNotice + "Products: Year 1: Subscriptions, tipping. Year 2: Courses, digital products, sponsorship marketplace. Year 3: Live events ticketing, merchandise. Verticals: Lifestyle → Education → Gaming → Business creators.",
          internationalPlan: templateNotice + "Year 3-4: US expansion (biggest creator market, 10x opportunity). Year 5: EU (localized for Germany, France). Strategy: Remote team, local payment methods. Focus: UK profitability and product-market fit before US.",
          vision: templateNotice + "5-year vision: Leading creator monetisation platform for mid-tier creators. 25,000 creators, £15M GMV, £2M revenue, 30 employees. Known for: Creator-first economics, integrated tools, community. Exit: Acquisition by social media platform or creator tools company.",
          targetEndorser: templateNotice + "Primary: Tech Nation (digital platform, creator economy). Alternative: Innovator International. Rationale: Tech Nation has strong digital platform portfolio, understands SaaS/marketplace businesses, connections to UK tech ecosystem.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Platform demo, creator traction metrics. (2) Month 6: Revenue growth, creator testimonials. (3) Month 12: Year 1 review, product roadmap. (4) Month 18: Team growth, Series A preparation. (5) Month 24: US expansion planning. (6) Month 30: Growth metrics, exit options.",
          experience: templateNotice + "Uniquely qualified: 3 years at Patreon managing £2M+ creator portfolio. Personal creator experience (50K YouTube subscribers). Deep understanding of creator pain points. Industry connections: creator agencies, brands, platforms. Proven ability to grow creator businesses.",
          revenue: templateNotice + "Platform commission: 15% of GMV (creator subscriptions/tips). Sponsorship marketplace: 20% of brand deals. Premium analytics: £15/month. Enterprise/agency: Custom pricing. Year 1: £150K revenue. Year 3: £1M. Gross margin: 75%.",
        },
      ...
      services: [
        { // ConsultX - Advisory Platform - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "340 SME clients across sectors: 85 retail/hospitality, 120 professional services, 80 manufacturing, 55 tech startups. Top clients: RegionalBank Ltd (5 projects, £18K), TechStartup Inc (3 projects, £12K). Testimonials available.",
          tractionEvidence: templateNotice + "£420K GMV in Year 1. 340 clients, 120 consultants. Average project: £3,200. Client satisfaction: 4.7/5. Consultant satisfaction: 4.6/5. Repeat client rate: 68%. Platform fee revenue: £63K (15% commission).",
          ...
          techStack: templateNotice + "Platform: React, Node.js, PostgreSQL. Payments: Stripe escrow. Video: Zoom API integration. Contracts: DocuSign integration. Matching: Custom algorithm based on skills, industry, availability.",
          dataArchitecture: templateNotice + "Consultant flow: Application → Vetting (portfolio, interview) → Profile creation → Project matching. Client flow: Brief submission → Consultant recommendations → Selection → Escrow payment → Project delivery → Review. Matching: Skills, industry, availability, ratings.",
          aiMethodology: templateNotice + "Not applicable - marketplace/platform business. Our innovation is in the vetting process and fixed-price model, not AI technology. We use standard web development with focus on trust and quality assurance systems.",
          complianceDesign: templateNotice + "GDPR compliant (data processing for consultants and clients). ICO registered. Platform terms of service with liability limitations. Professional indemnity recommendation for consultants. Escrow payment protection. Dispute resolution process.",
          patentStatus: templateNotice + "No patents filed - business model innovation. Trademark: 'ConsultX' registered (UK00003901234). Trade secrets: Vetting criteria and matching algorithm documented confidentially.",
          founderEducation: templateNotice + "MBA, London Business School, 2020. BA Economics, University of Oxford, 2016 (First Class). CMI Level 7 Strategic Management. Project Management Professional (PMP).",
          founderWorkHistory: templateNotice + "Strategy Consultant, McKinsey & Company (2020-2024): Led 15+ projects for FTSE 250 clients, £2M+ in fees. Business Analyst, Deloitte (2016-2018): Financial services consulting. Founded student consultancy at Oxford (£50K revenue).",
          founderAchievements: templateNotice + "Led McKinsey projects generating £2M+ in fees. Promoted to Engagement Manager in 3 years (top 10%). Founded Oxford student consultancy (£50K revenue). Speaker at Management Consulting Association events. Mentored 12 junior consultants.",
          relevantProjects: templateNotice + "McKinsey: Digital transformation for FTSE 250 retailer (£800K project). Deloitte: Bank operational efficiency review. Oxford: Built student consultancy matching 50 students with 30 clients. Personal: Advised 10 SMEs pro-bono during COVID.",
          funding: "65000",
          fundingSources: templateNotice + "£40,000 personal savings. £15,000 family investment. £10,000 London Business School Entrepreneurship Grant (reference: LBS-2024-456). Total: £65,000 for platform development and initial marketing.",
          monthlyProjections: templateNotice + "Year 1: £5.25K/month platform fees, £3.5K costs. Year 2: £15K/month (800 clients, 250 consultants), £10K costs. Year 3: £40K/month (2,000 clients), £25K costs. Break-even Month 4. Year 3: £480K revenue.",
          customerAcquisitionCost: "85",
          lifetimeValue: "960",
          paybackPeriod: "1",
          detailedCosts: templateNotice + "Platform hosting: £1K/month. Stripe/payment fees: 1.5% of GMV. Marketing: £1.5K/month. Legal/contracts: £5K/year. Staff (Year 2): £80K/year. Customer support: Part-time contractor. Total Year 1: £42K.",
          competitors: templateNotice + "1. Consultport (global, enterprise focus). 2. Expert360 (Australian, established). 3. Comatch (German, premium pricing). 4. Catalant (US, large corporations). 5. LinkedIn ProFinder (broad, not curated). Our advantage: UK SME focus, fixed pricing, heavy vetting.",
          competitiveDifferentiation: templateNotice + "UK SME focus (vs enterprise-focused competitors). Fixed-price projects (vs hourly - eliminates budget uncertainty). 15% acceptance rate vetting (vs open platforms). Escrow payments (unique protection). Average £150/hour (vs £500+ traditional consulting).",
          customerInterviews: templateNotice + "40 SME owner interviews. Findings: (1) Need strategic advice but can't afford Big 4. (2) Hourly billing creates budget anxiety. (3) Quality concerns with freelance platforms. (4) Want UK-based consultants who understand local market. (5) Fixed price = easier budgeting.",
          lettersOfIntent: templateNotice + "Corporate partnerships: 2 accelerators (access to 80 startups). Consultant partnerships: 25 ex-McKinsey/BCG consultants committed. Client LOIs: 3 SME associations (1,200 member companies) for promotion.",
          willingnessToPay: templateNotice + "Client pricing: 15% platform fee on project value (vs 20-30% agencies). Consultant: Free listing, 15% of earnings. Premium features: £49/month for priority matching. Average project: £3,200 (range £500-15,000).",
          marketSize: templateNotice + "TAM: UK management consulting £12B. SAM: SME consulting £1.8B. SOM: Year 1: £420K GMV, £63K revenue. Year 3: £3.2M GMV, £480K revenue. 0.03% SAM penetration Year 3 (conservative).",
          regulatoryRequirements: templateNotice + "GDPR: Data processing for consultants/clients. ICO registration: Completed. Platform liability: Terms of service, limitation of liability. No professional licensing required for platform (consultants self-certify qualifications).",
          complianceTimeline: templateNotice + "Month 1: ICO registration (completed). Month 3: Legal review of terms/contracts. Month 6: GDPR audit. Month 12: Insurance review (platform liability). Ongoing: Consultant vetting process documentation.",
          complianceBudget: "8000",
          jobCreation: "10",
          hiringPlan: templateNotice + "Year 1: Founder + part-time contractor (vetting). Year 2: Operations Manager (£40K), Developer (£55K), Sales/Marketing (£38K). Year 3: Customer Success (2 × £32K), Quality Lead (£42K). Total: 10 by Year 3.",
          specificRegions: templateNotice + "Year 1: London (highest SME density, consultant pool). Year 2: Manchester, Birmingham, Bristol. Year 3: National UK coverage. Consultant network: Initially London-based, remote delivery enables national.",
          expansion: templateNotice + "Verticals: Year 1: General business. Year 2: Specialist tracks (finance, operations, digital). Year 3: Industry-specific (hospitality, retail, professional services). Products: Add training, workshops, retainer packages.",
          internationalPlan: templateNotice + "Year 4: Ireland (English-speaking, similar market). Year 5: Western Europe (DE, FR - localized). Strategy: Focus UK profitability before expansion. Remote delivery model enables gradual international growth.",
          vision: templateNotice + "5-year vision: UK's leading SME consulting marketplace. £20M GMV, £3M platform revenue, 5,000 consultants, 15,000 clients, 25 employees. Known for: Quality, accessibility, SME champion. Exit: Acquisition by HR/consulting platform or private equity.",
          targetEndorser: templateNotice + "Primary: Innovator International (services expertise, marketplace understanding). Alternative: Tech Nation (if highlighting platform technology). Rationale: Innovator International understands professional services, has B2B platform portfolio.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Platform demo, client/consultant traction. (2) Month 6: Revenue growth, quality metrics. (3) Month 12: Year 1 review, expansion plans. (4) Month 18: New verticals launch. (5) Month 24: Team growth, funding round. (6) Month 30: Exit planning, international.",
          experience: templateNotice + "Uniquely qualified: 4 years McKinsey (£2M+ in project fees). Built student consultancy (£50K revenue). Deep understanding of both consultant and client perspectives. Industry connections: Big 4 alumni network. Proven ability to match consultants with clients.",
          revenue: templateNotice + "Platform commission: 15% of project value (from both sides = 7.5% each). Premium listings: £49/month for priority matching. Enterprise: Custom pricing for large clients. Year 1: £63K revenue (15% of £420K GMV). Year 3: £480K (15% of £3.2M).",
        },
      ...
      social: [
        { // ImpactFirst - Social Innovation - COMPREHENSIVE
          ...
          existingCustomers: templateNotice + "45 social enterprises (active seekers), 180 registered investors. Completed deals: 12 investments totalling £2.1M. Key enterprises: Community Energy Co-op (£350K raised), Social Housing Trust (£280K raised). Investor testimonials available.",
          tractionEvidence: templateNotice + "£2.1M raised across 12 deals. 45 social enterprises registered, 180 investors. Average deal: £175K. Deal success rate: 35%. Platform commission revenue: £105K (5% of capital raised). B Corp certified.",
          ...
          techStack: templateNotice + "Platform: React, PostgreSQL. Payments: Stripe Connect. Impact tracking: Custom dashboard. Documents: DocuSign. Due diligence: Integrated document management.",
          dataArchitecture: templateNotice + "Social enterprise flow: Application → Impact assessment → Due diligence → Profile creation → Investor matching → Campaign live → Investment collection → Post-investment reporting. Impact tracking: Standardised metrics (jobs, carbon, community reach) with quarterly reporting.",
          aiMethodology: templateNotice + "Not applicable - impact investment platform. Our innovation is in impact measurement frameworks and blended finance structures, not AI technology. We use social enterprise assessment methodologies with technology-enabled matching.",
          complianceDesign: templateNotice + "FCA registered (if facilitating investments). Crowdfunding regulations (ECSR compliance). Social Enterprise Mark (achieved). B Corp certification (achieved). GDPR compliant. Anti-money laundering (AML) checks on investors.",
          patentStatus: templateNotice + "No patents filed - methodology and framework innovation. Trademark: 'ImpactFirst' registered (UK00003912345). Trade secrets: Impact measurement methodology documented. Social Enterprise Mark holder.",
          founderEducation: templateNotice + "MSc Social Innovation, London School of Economics, 2020. BA Politics & Economics, SOAS University, 2017 (First Class). CFA Level 1 (passed). Social Enterprise Accelerator graduate (UnLtd).",
          founderWorkHistory: templateNotice + "Investment Manager, Big Society Capital (2020-2024): Deployed £15M to social enterprises. Programme Manager, UnLtd (2018-2020): Supported 100+ social entrepreneurs. Volunteer, Oxfam (2015-2017): Community development projects in Nigeria.",
          founderAchievements: templateNotice + "Deployed £15M social investment at Big Society Capital (25 deals). Supported 100+ social entrepreneurs at UnLtd. Founded student social enterprise at SOAS (£20K revenue, 50 beneficiaries). Speaker at Social Enterprise World Forum 2023.",
          relevantProjects: templateNotice + "Big Society Capital: Led 25 social enterprise investments (£15M deployed). UnLtd: Designed social enterprise support programme. Personal: Founded student social enterprise serving 50 beneficiaries. LSE dissertation: 'Blended Finance for Social Impact'.",
          funding: "85000",
          fundingSources: templateNotice + "£30,000 personal savings. £25,000 family investment (social impact loan). £30,000 Access Foundation for Social Investment grant (reference: ACCESS-2024-789). Total: £85,000 for platform development.",
          monthlyProjections: templateNotice + "Year 1: £8.75K/month platform fees, £6K costs. Year 2: £25K/month (£6M capital raised), £18K costs. Year 3: £50K/month (£12M capital raised), £35K costs. Break-even Month 8. Year 3: £600K revenue.",
          customerAcquisitionCost: "450",
          lifetimeValue: "8750",
          paybackPeriod: "1",
          detailedCosts: templateNotice + "Platform hosting: £1.5K/month. Legal/compliance: £15K/year. Due diligence service: £3K/month. Staff (Year 2): £100K/year. Marketing/events: £2K/month. Impact reporting: £1K/month. Total Year 1: £72K.",
          competitors: templateNotice + "1. Ethex (established, retail focus). 2. Lendahand (international development). 3. Abundance Investment (energy focus). 4. Triodos Bank (traditional bank). 5. Big Society Capital (wholesale investor). Our advantage: Blended finance innovation, SME social enterprise focus, impact framework.",
          competitiveDifferentiation: templateNotice + "Blended finance: Combine grants + investment (unique approach). Impact framework: Standardised metrics for comparison. SME focus: £50K-500K deals (underserved market). Community investors: Retail + institutional combined. Due diligence service: Reduces investor risk.",
          customerInterviews: templateNotice + "35 interviews (20 social enterprises, 15 impact investors). Findings: (1) Social enterprises stuck between grants and commercial investment. (2) Investors want standardised impact metrics. (3) Due diligence is barrier for smaller investors. (4) Blended structures attractive to both sides. (5) Network/community valued.",
          lettersOfIntent: templateNotice + "Pipeline: 8 social enterprises seeking £1.4M (combined). Investor commitments: 25 investors with £2.5M indicated capacity. Partnerships: 2 social enterprise networks (access to 500 members). Foundation partner: £100K guarantee fund discussion.",
          willingnessToPay: templateNotice + "Enterprise fee: 5% of capital raised (success-based). Investor fee: None (attracted by deal flow). Premium services: Due diligence £2K, Impact reporting £500/year. Average deal: £175K, £8,750 revenue per successful deal.",
          marketSize: templateNotice + "TAM: UK social investment market £7.9B. SAM: SME social enterprise investment £1.2B. SOM: Year 1: £2.1M capital (£105K revenue). Year 3: £12M capital (£600K revenue). 1% SAM penetration Year 3.",
          regulatoryRequirements: templateNotice + "FCA registration: Required if facilitating investments (6-12 months, £5K). FSCS compliance: If holding client money. AML/KYC: Investor verification. GDPR: Data protection for all parties. Social Enterprise Mark: Achieved.",
          complianceTimeline: templateNotice + "Month 1-6: FCA registration application. Month 3: AML/KYC process implementation. Month 6: Platform terms and investor agreements. Month 12: Compliance audit. Ongoing: FCA reporting, AML monitoring.",
          complianceBudget: "25000",
          jobCreation: "12",
          hiringPlan: templateNotice + "Year 1: Founder + part-time analyst. Year 2: Investment Manager (£50K), Community Manager (£38K), Developer (£55K). Year 3: Due Diligence Lead (£45K), Marketing (£40K), Operations (£35K), Admin (£28K). Total: 12 by Year 3.",
          specificRegions: templateNotice + "Year 1: London (social enterprise density, investor network). Year 2: Manchester, Bristol, Birmingham (strong social enterprise ecosystems). Year 3: National coverage. Focus: Areas with active social enterprise support (Local Enterprise Partnerships).",
          expansion: templateNotice + "Products: Year 1: Equity investment matching. Year 2: Add loans, revenue-based financing. Year 3: Secondary market, impact funds. Sectors: General → Specific tracks (housing, energy, employment, health).",
          internationalPlan: templateNotice + "Year 4: Ireland (EU social enterprise market). Year 5: European Social Fund alignment opportunities. Strategy: UK social investment ecosystem leadership first. International via partnerships with local platforms.",
          vision: templateNotice + "5-year vision: UK's leading social enterprise investment platform. £50M capital raised, £2.5M revenue, 300 social enterprises funded, 500 investors, 20 employees. Known for: Blended finance innovation, impact measurement. Exit: Acquisition by impact investor or financial services company.",
          targetEndorser: templateNotice + "Primary: Innovator International (social enterprise understanding). Alternative: Global Entrepreneur Programme (scaling ambitious businesses). Rationale: Innovator International has social enterprise portfolio, understands impact measurement, connections to social investment ecosystem.",
          contactPointsStrategy: templateNotice + "6 engagement points: (1) Month 1: Platform demo, deal pipeline. (2) Month 6: Capital raised metrics, investor growth. (3) Month 12: Year 1 review, impact report. (4) Month 18: New product launches. (5) Month 24: Team growth, expansion. (6) Month 30: Exit planning, international.",
          experience: templateNotice + "Uniquely qualified: 4 years at Big Society Capital (£15M deployed, 25 deals). Social enterprise support experience (UnLtd, 100+ entrepreneurs). Founded student social enterprise. Deep understanding of social investment ecosystem. Industry connections: impact investors, foundations, social enterprises.",
          revenue: templateNotice + "Platform fee: 5% of capital raised (from social enterprise). Premium services: Due diligence £2K, Impact reporting £500/year. Institutional: White-label platform licensing. Year 1: £105K (5% of £2.1M). Year 3: £600K (5% of £12M). Gross margin: 80%.",
        },
