...
export default function QuestionnaireForm({ tier = 'premium' }: { tier?: string }) {
  ...
  const handleEbukaUltimatePlanAutoFill = () => {
    ...
    const demoData: Record<string, string> = {
      ...
      competitiveDifferentiation: templateNotice + "MEASURABLE COMPETITIVE ADVANTAGES: (1) Tool Count: 109 specialized tools vs competitors' 10-20 generic tools (10x more comprehensive). (2) Cost: £29-129 vs £3,000-15,000 traditional services (97% savings). (3) Speed: Instant access vs 2-4 weeks lawyer scheduling. (4) Specialization: 100% Innovator Founder Visa focus vs competitors' broad visa coverage. (5) AI Quality: Multi-LLM (GPT-4 + Gemini) vs single model or no AI. (6) Accessibility: 24/7 global access vs UK office hours only. (7) Currency: Real-time policy updates (November 2025 guidance) vs outdated templates. (8) Evidence Focus: Addresses all 8 critical rejection reasons vs generic advice. (9) Self-Service: Full capability without human dependency vs consultant bottleneck. (10) First-Mover: Only comprehensive platform in market. VALIDATED BY: 47 users in 30 days with £0 marketing spend, organic SEO traction.",
    ...
    const industryTemplates: Record<string, Record<string, string>[]> = {
      fintech: [
        { // FinFlow AI - Cash Flow Forecasting - COMPREHENSIVE
          ...
          competitors: templateNotice + "1. Fluidly (£99/month, 78% accuracy, acquired by Sage). 2. Float (£49/month, manual data entry, no AI). 3. Futrli (£35/month, basic forecasting). 4. Pulse (US-focused, £79/month). 5. Brixx (£29/month, spreadsheet-based). Our advantage: Only AI-powered solution with Open Banking integration at SME price point.",
      ...
      creative: [
        { // StoryStream - Content Platform - COMPREHENSIVE
          ...
          willingnessToPay: templateNotice + "Creator pricing: 15% platform fee (accepted by 89% in survey). Subscriber pricing: £3-15/month (creator-set). Additional revenue: Sponsorship marketplace 20% fee. Premium analytics: £29/month optional. Conversion: 6% subscriber rate from free audience.",
          ...
          revenue: templateNotice + "Platform commission: 15% of GMV (creator subscriptions/tips). Sponsorship marketplace: 20% of brand deals. Premium analytics: £29/month. Enterprise/agency: Custom pricing. Year 1: £150K revenue. Year 3: £1M. Gross margin: 75%.",
        },
