...
export default function QuestionnaireForm({ tier = 'premium' }: { tier?: string }) {
  ...
  const handleLoadIndustryTemplate = (industry: string, templateIndex: number) => {
    ...
    const baseTemplateData: Record<string, string> = {
      ...
      technicalSkillsProficiency: "React 18 (9/10), TypeScript (9/10), Node.js/Express (9/10), PostgreSQL (8/10), OpenAI/Gemini/Claude APIs (9/10), Tailwind CSS/Shadcn UI (9/10), GA4/Power BI (8/10), Python/SQL (8/10), Stripe Integration (8/10), Drizzle ORM (8/10).",
