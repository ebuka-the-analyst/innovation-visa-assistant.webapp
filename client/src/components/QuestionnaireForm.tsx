...
export default function QuestionnaireForm({ tier = 'premium' }: { tier?: string }) {
  ...
  const handleLoadIndustryTemplate = (industry: string, templateIndex: number) => {
    ...
    const industryTemplates: Record<string, Record<string, string>[]> = {
      fintech: [
        ...
        { // PaymentPro - B2B Payments - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (FinTech specialization, strong B2B portfolio). Alternative: Barclays Eagle Labs (banking connections, enterprise partnerships). Rationale: Tech Nation has deep FinTech expertise, portfolio includes Wise alumni companies, active in payments vertical.",
        ...
        { // LendSmart - SME Lending - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Barclays Eagle Labs (banking relationships, enterprise connections, lending expertise). Alternative: Tech Nation (fintech specialization). Rationale: Eagle Labs has deep connections into traditional banking (partnership/acquisition targets), understands FCA authorization journey, portfolio includes lending startups.",
      ...
      healthtech: [
        { // CareAI - Patient Management - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Digital Health London (NHS focus, healthtech specialization). Alternative: Tech Nation (digital business expertise). Rationale: Digital Health London has deep NHS connections, portfolio includes successful NHS startups, understands NHS procurement and clinical safety requirements.",
        ...
        { // MedAssist - Clinical Decision Support - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Digital Health London (NHS HealthTech expertise). Alternative: Oxford Innovation (spinout support, life sciences). Rationale: Digital Health London understands clinical AI regulatory pathway, portfolio includes MHRA-certified companies, strong NHS AHSN network connections.",
        ...
        { // HealthFlow - NHS Integration - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (digital infrastructure expertise). Alternative: Digital Health London (NHS relationships). Rationale: Tech Nation understands platform/infrastructure businesses, has connections to enterprise buyers and investors. Digital Health London as secondary for NHS-specific guidance.",
      ...
      ecommerce: [
        { // ShopSmart - AI Recommendations - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (digital business, e-commerce focus). Alternative: Innovator International (retail technology). Rationale: Tech Nation has strong e-commerce portfolio, understands SaaS metrics, connected to retail tech ecosystem.",
        ...
        { // RetailFlow - Inventory Optimization - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (retail technology, SaaS expertise). Alternative: Retail Week Accelerator (retail industry connections). Rationale: Tech Nation understands SaaS metrics, has retail tech portfolio, connected to investor community.",
        ...
        { // MarketPro - Marketplace Platform - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (marketplace/platform expertise). Alternative: Barclays Eagle Labs (B2B commerce, banking connections for trade credit). Rationale: Tech Nation has marketplace companies in portfolio, understands two-sided platform metrics, connected to investor community.",
      ...
      saas: [
        { // TeamFlow - Collaboration Platform - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (SaaS expertise, collaboration tools in portfolio). Alternative: Notion/Slack alumni network (industry credibility). Rationale: Tech Nation understands SaaS metrics, has strong PLG company portfolio, connected to European expansion resources.",
        ...
        { // DataSync - Integration Platform - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (SaaS expertise). Alternative: Sage/Xero partner networks (industry credibility). Rationale: Tech Nation understands integration/platform businesses, has strong portfolio in B2B SaaS, connected to Manchester tech ecosystem.",
        ...
        { // AutomateHQ - Workflow Automation - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (AI/automation expertise). Alternative: Edinburgh AI cluster (research connections). Rationale: Tech Nation has automation/AI companies in portfolio, understands enterprise vs SME dynamics, connected to investor community.",
      ...
      manufacturing: [
        ...
        { // CleanMaterials - Eco Products - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Innovator International (manufacturing expertise, sustainability focus). Alternative: Tech Nation (if emphasizing biotech innovation). Rationale: Innovator International understands manufacturing, has sustainable products portfolio, mentor network includes FMCG executives.",
      ...
      creative: [
        ...
        { // ArtConnect - Creative Marketplace - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (digital platform, creative industries). Alternative: Innovator International. Rationale: Tech Nation has creative tech portfolio, understands marketplace businesses, connections to arts and culture sector.",
        ...
        { // MediaFlow - Distribution Innovation - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (digital platform, creative industries). Alternative: Innovator International (media expertise). Rationale: Tech Nation has strong creative/media portfolio, understands marketplace models, connections to film industry.",
      ...
      services: [
        ...
        { // TalentBridge - Recruitment Innovation - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (HR tech, marketplace platform). Alternative: Innovator International (services expertise). Rationale: Tech Nation has HR tech portfolio, understands marketplace dynamics, connections to staffing industry.",
        ...
        { // ServicePro - B2B Solutions - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Innovator International (services expertise, B2B marketplace understanding). Alternative: Tech Nation (platform model). Rationale: Innovator International understands B2B services, has facilities management contacts, mentor network includes operations executives.",
      ...
      social: [
        ...
        { // CommunityHub - Local Solutions - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Innovator International (social enterprise understanding). Alternative: Tech Nation (platform technology). Rationale: Innovator International has social enterprise portfolio, understands community business models, connections to impact investors.",
        ...
        { // GreenFuture - Sustainability Venture - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Innovator International (social enterprise, education expertise). Alternative: Tech Nation (EdTech platform elements). Rationale: Innovator International has social enterprise portfolio, education sector connections, understands blended funding models.",
      ...
      other: [
        { // EduAI - Learning Platform - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (AI technology, EdTech sector). Alternative: Innovator International (education expertise). Rationale: Tech Nation has AI portfolio, EdTech sector experience, connections to education and technology investors.",
        ...
        { // PropFlow - Property Management - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (PropTech, SaaS platform). Alternative: Innovator International (property expertise). Rationale: Tech Nation has PropTech portfolio, understands SaaS metrics, connections to property technology investors.",
        ...
        { // GreenTech - Sustainability Platform - COMPREHENSIVE
          ...
          targetEndorser: "Primary: Tech Nation (CleanTech, data platform). Alternative: Innovator International (sustainability expertise). Rationale: Tech Nation has strong CleanTech portfolio, understands data-driven platforms, connections to Net Zero investors.",
    ...
    const baseTemplateData: Record<string, string> = {
      ...
      targetEndorser: "Primary: Tech Nation (strong track record with FinTech, data companies). Alternative: Innovator International (broader business focus). Rationale: Tech Nation's network includes key investors, proven support for similar ventures.",
