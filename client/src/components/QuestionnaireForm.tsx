...
// Owner-only prefill data for benedict9211@gmail.com
const BENEDICT_PREFILL_DATA: Record<string, string> = {
  // Step 0 - Personal Profile
  fullLegalName: "Benedict Ebuka Umeh",
  currentVisaStatus: "graduate-visa",
  visaExpiryDate: "23/05/2026",
  workAuthorizationDetails: "Currently on UK Graduate Visa (expires 23/05/2026). Permitted to work full-time without restrictions. Self-employment is allowed under Graduate Visa conditions. No hours limits apply. Currently working as CTO/Lead Developer at Stackrise Ltd (self-employed/director). Visa allows establishing and running a business in the UK.",
  educationBackground: "MSc Data Science - Leeds Beckett University, UK, 2023, Distinction. Focus: Advanced Machine Learning, Deep Learning, NLP, Statistical Modelling, Big Data Analytics, Python programming.\n\nBSc Information Technology & Business Information Systems - Middlesex University, UK, 2017, 2:1. Focus: Systems Analysis, IT Management, Business Process Management, Database Design, Software Engineering.\n\nAdvanced Diploma in Software Engineering - Aptech Computer Institute, Nigeria, 2016. Focus: Full-Stack Development Fundamentals, Software Architecture, OOP.",
  professionalCertifications: "Google Data Analytics Professional Certificate (Coursera, 2023)\nIBM Data Analyst Professional Certificate (Coursera, 2023)\nProgramming Fundamentals (Coursera/Duke University, 2023)\nSEO Specialist Certificate (Semrush Academy, 2024)\nFCA Financial Services Training (2024)",
  totalProfessionalExperience: "7",
  industryExperience: "7+ years in technology (full-stack development, AI/ML, data analytics). 3+ years specifically in Legal Tech / Immigration Tech / AI SaaS. Built the complete Visa Assistant Global platform (109 tools, multi-agent AI) independently. 2.5 years working with financial data at FinTech. Roles: CTO at Stackrise Ltd, Web & Performance Analyst at Qalhata Technologies, Web Developer at Deskstones Ltd, Web Developer/Analyst at Eden Health Care. Deep expertise in React, TypeScript, Node.js, PostgreSQL, Qwen AI APIs, Stripe payments, Google Analytics 4.",
  technicalSkillsProficiency: "TECHNICAL SKILLS: React/TypeScript (10/10), Node.js/Express (9/10), PostgreSQL/Drizzle ORM (9/10), Python/ML (8/10), Qwen/OpenAI APIs (9/10), Stripe Integration (9/10), AWS S3 (8/10), Google Analytics 4 (9/10), Docker/Railway (7/10), Git/CI-CD (8/10).\n\nBUSINESS SKILLS: Product Management (9/10), Technical Architecture (10/10), Financial Modelling (8/10), SEO/Content Marketing (8/10), Customer Discovery (8/10), Sales (7/10).\n\nPROJECT DELIVERY: Led 10+ production deployments. Built SaaS platforms serving real paying customers. 100% on-time delivery track record.",
  languagesSpoken: "English (Fluent/Professional - primary working language)\nIgbo (Native speaker)\nYoruba (Conversational)",
  linkedInProfile: "https://www.linkedin.com/in/benedict-umeh/",
  portfolioUrl: "https://github.com/benedict-umeh | https://visaassistant.global",
  ...
  // Step 2 - Innovation & Technology
  uniqueness: "WORLD'S FIRST multi-agent AI system purpose-built for global visa applications. Key innovations: (1) MULTI-AGENT ARCHITECTURE - Four specialized AI agents (Nova, Sterling, Atlas, Sage) collaborate intelligently, unlike single-chatbot competitors, providing comprehensive guidance across innovation, finance, growth, and compliance dimensions. (2) 100X COST REDUCTION - £35/month subscription vs £5,000-25,000 traditional legal fees. (3) INSTANT FEEDBACK - Real-time AI guidance vs 2-4 weeks waiting for lawyer appointments. (4) DOCUMENT INTELLIGENCE - Qwen VL Vision auto-extracts and auto-populates business plans from uploaded documents. (5) COMPLIANCE SCORING - Real-time scoring against official endorsing body criteria. (6) GLOBAL SCALABILITY - Template architecture allows rapid expansion to any country's visa system. (7) MULTI-LANGUAGE - 8 languages including RTL support for Arabic. No competitor offers this combination of multi-agent AI, document intelligence, and global scalability.",
  techStack: "Frontend: React 18, TypeScript, Tailwind CSS, Shadcn UI, Framer Motion, Recharts\nBackend: Node.js, Express.js, PostgreSQL, Drizzle ORM\nAI: Qwen API (qwen-plus, qwen-turbo, qwen-vl-plus), Function Calling/Tool Use, Multi-Agent Orchestration\nAuth: Google OAuth 2.0, Passport.js, Session Management, Cloudflare Turnstile bot protection\nPayments: Stripe (live subscriptions, invoicing, tier-based access)\nStorage: AWS S3 (documents), Object Storage for assets\nEmail: Hostinger SMTP, Resend API\nAnalytics: GA4, Custom real-time activity tracking\nExports: jsPDF, html-to-image, docx for visual business plan exports\nInfra: Railway deployment, Neon PostgreSQL",
  dataArchitecture: "Secure PostgreSQL database with Drizzle ORM for type-safe queries. Document storage on AWS S3 with presigned URLs. Session-based authentication with secure cookies and CSRF protection. Real-time activity tracking with heartbeat monitoring (30-second intervals). AI agents communicate through structured function calling with JSON schemas. Business plan generation uses template-based sections with AI content generation and SVG chart visualization. Five-tier access control (Free/Basic/Premium/Enterprise/Ultimate) enforced at middleware level.",
  aiMethodology: "Four specialized AI agents orchestrated by a central router: Nova (Innovation Analysis) evaluates product uniqueness, IP potential, and endorsement criteria alignment. Sterling (Financial Intelligence) builds financial models, revenue projections, and unit economics. Atlas (Growth Strategy) develops market expansion, customer acquisition, and scaling roadmaps. Sage (Compliance Officer) ensures GDPR, OISC, and UK visa regulation compliance. Agents use function calling with structured JSON schemas for reliable outputs. Qwen qwen-plus for complex reasoning, qwen-turbo for speed, qwen-vl-plus for document vision extraction. Multi-agent collaboration produces comprehensive business plans that single-agent systems cannot achieve.",
  patentStatus: "No patents filed. IP protection strategy focuses on: (1) Trade secrets - Multi-agent orchestration algorithms and compliance scoring models. (2) Copyright - All platform code, content, and training data built entirely by founder. (3) Trademarks - 'Visa Assistant Global', 'Nova AI', 'Sterling AI', 'Atlas AI', 'Sage AI' pending registration with UKIPO. Future patent applications planned for AI-powered visa compliance scoring method once revenue enables filing costs.",
  // Step 3 - Market Validation
  customerInterviews: "25+ discovery interviews conducted: 12 visa applicants (Graduate visa holders, Skilled Worker visa holders exploring Innovator route), 5 immigration solicitors, 3 endorsing body representatives, 2 UKVI policy advisors, 3 startup founders who previously applied. Key insights: 78% found existing resources confusing, 85% couldn't afford lawyer fees, 92% wanted AI-powered document review. Immigration lawyers confirmed tool accuracy and expressed interest in white-label partnership. Validation confirmed product-market fit and optimal price points.",
  lettersOfIntent: "2 immigration lawyers actively using platform to assist their clients (verbal agreements for formal partnership pending). 3 startup accelerators expressed interest in bulk licensing for their cohorts. 1 university international office exploring student entrepreneur pilot. Platform live with 7 paying users validating product-market fit. Formal LOIs being converted to written agreements in Month 1-2.",
  willingnessToPay: "7 active paying users on live platform. Price testing showed optimal price point at £35/month (Basic), £99/month (Premium). 2 immigration lawyers paying Premium tier. Survey of 50 visa applicants: 73% willing to pay £20-50/month, 45% willing to pay £50-100/month for comprehensive solution. Competitor pricing analysis supports premium positioning.",
  marketSize: "TAM: £17 billion global immigration services market (850M+ visa applications annually). SAM: £2.1 billion UK immigration services market (600,000+ visa applications/year, average spend £3,500). SOM Year 1: £180,000 (500 subscribers at £30/month average). SOM Year 3: £2.4 million (4,000 subscribers). SOM Year 5: £12 million (15,000 subscribers + B2B licensing).",
  // Step 4 - Compliance & Regulation
  regulatoryRequirements: "GDPR compliance (data protection for EU/UK users). ICO registration (£40-2,900 based on turnover). Cyber Essentials certification (£300-500). Terms of Service and Privacy Policy (legal review £500). OISC compliance disclaimer (not regulated advice - clear user disclaimers prominently displayed on all outputs). PCI-DSS compliance via Stripe (no additional cost). Cookie consent and privacy notices. Accessibility compliance (WCAG 2.1 AA). Not regulated as legal advice provider (OISC exemption applies).",
  complianceTimeline: "Month 1: ICO registration complete, Privacy Policy and Terms of Service published. Month 2-3: Cyber Essentials certification (£300). Month 4-6: GDPR audit and comprehensive documentation. Month 7-9: Accessibility audit (WCAG 2.1 AA). Month 10-12: ISO 27001 preparation for enterprise clients. Ongoing: OISC disclaimer prominently displayed on all AI outputs, quarterly compliance reviews, annual legal audit.",
  complianceBudget: "3500",
  // Step 5 - Scalability & Growth
  jobCreation: "8",
  hiringPlan: "Year 1: Founder/CEO Benedict Umeh (£0 - equity only), Part-time Customer Success Manager (£12,000/year). Total: 1.5 FTE.\n\nYear 2: Full-time Developer (£45,000), Marketing Manager (£38,000), Customer Success upgraded to full-time (£28,000). Total: 4.5 FTE.\n\nYear 3: Senior Developer (£55,000), Sales Manager (£42,000 + commission), Content Writer (£32,000), Operations Manager (£35,000). Total: 8.5 FTE.\n\nAll positions UK-based in Leeds/London. Prioritize diverse talent including immigrants with visa application experience.",
  specificRegions: "Phase 1 (Year 1): Greater London, Greater Manchester, Birmingham, Bristol, Edinburgh - highest concentration of visa applicants and startup ecosystems.\n\nPhase 2 (Year 2): Leeds, Liverpool, Glasgow, Cardiff, Cambridge, Oxford - university cities with international student entrepreneurs.\n\nPhase 3 (Year 3): Belfast, Newcastle, Nottingham, Sheffield - emerging tech hubs.",
  expansion: "Year 1: UK Innovator Founder Visa (109 tools complete). Year 2: Expand to Skilled Worker visa and Global Talent visa modules. Partnership with 10 immigration law firms for white-label solution. Year 3: Scale Business visa category, launch enterprise API for HR platforms. Technology architecture already supports multi-country deployment with minimal additional development per country.",
  internationalPlan: "Year 2-3: Canada (Express Entry), Australia (Business Innovation visa), UAE (Golden Visa) - markets with similar points-based/endorsement systems. Only after UK market validation and £500K+ ARR. Local legal partnerships required for each jurisdiction. Technology architecture already supports multi-country deployment. Target 16 countries by Year 5 with 50,000+ users.",
  vision: "5-Year Vision: Become the world's leading AI-powered visa preparation platform. 50,000+ users across 10 countries. £12M ARR. Team of 25+ specialists. Strategic partnerships with 50+ immigration law firms. API integrations with major HR platforms (Workday, SAP SuccessFactors). Potential acquisition target for legal tech or HR tech company at £50-100M valuation. Democratizing access to immigration guidance for 850M+ annual global visa applicants.",
  // Step 6 - Endorsement
  targetEndorser: "Primary: Envestors (tech-enabled businesses with scalable models, clear innovation, global potential). Criteria alignment: AI/SaaS platform, 109 proprietary tools, multi-agent architecture, global expansion roadmap, working MVP with paying users.\n\nAlternative: Innovator International (sector-agnostic, strong for LegalTech/AI). UKES also considered.\n\nRationale: Envestors has endorsed multiple AI SaaS platforms and has clear criteria for innovation (first-in-market), viability (working product + revenue), and scalability (global TAM). Direct alignment with all three endorsement criteria.",
  contactPointsStrategy: "Contact 1 (Month 0): Initial endorsement interview and full business plan presentation. Contact 2 (Month 6): First progress report - user growth from 7 to 50+, revenue milestones £5K MRR, product development updates (new visa categories added). Contact 3 (Month 12): Annual review meeting - Year 1 achievements, financial performance, job creation progress (1 employee hired). Contact 4 (Month 18): Mid-year check-in - expansion into Skilled Worker visa category, law firm partnership announcements. Contact 5 (Month 24): Second annual review - Year 2 growth to 500+ users, £120K ARR, team of 4.5 FTE. Contact 6 (Month 30): Pre-ILR review preparation - sustained innovation documentation, UK economic contribution, settlement evidence preparation.",
  // Step 7 - Financial
  funding: "5000",
  fundingSources: "Personal savings: £2,000 (40%). Family loan: £4,000 at 0% interest, repayable over 24 months (60%). Total: £5,000. Bootstrap model with reinvestment of early revenue. No external investor dilution at seed stage. Platform already built - capital used for marketing, infrastructure scaling, and initial operations. Revenue-first approach reduces external funding dependency.",
  monthlyProjections: "Year 1: Months 1-3: £0 revenue (beta testing), £400/month costs. Months 4-6: £1,500 MRR (30 subscribers), £600 costs. Months 7-12: £4,000 MRR (80 subscribers), £800 costs. Year 1 total: £27,000 revenue, £7,200 costs, £19,800 profit.\n\nYear 2: £10,000 MRR by month 24, £120,000 annual revenue, £60,000 net profit.\n\nYear 3: £25,000 MRR, £300,000 annual revenue, £180,000 net profit.",
  customerAcquisitionCost: "25",
  lifetimeValue: "420",
  paybackPeriod: "1",
  detailedCosts: "Technology & Infrastructure (£1,600/year): Cloud hosting £600 (Railway), domain £50, database £300, API costs (Qwen AI) £400, dev tools £250.\n\nMarketing (£1,800/year): Content marketing £600, paid ads £800, events £200, social media tools £200.\n\nOperations (£1,200/year): Company formation £50, ICO registration £40, legal review £500, accounting £150, insurance £300, misc £160.\n\nContractor Support (£1,000/year): Part-time support £600, design £250, copywriting £150.\n\nContingency (£400). Total Year 1: £6,000.",
  competitors: "1. Fragomen (global immigration law firm - £5,000-25,000 per case). 2. PwC Legal Immigration Services (£3,000-15,000 per case). 3. Immigram (UK startup visa platform - £299-999). 4. Jobbatical (relocation/visa SaaS - $500+). 5. Boundless Immigration (US-focused - $750-2,000). 6. Visa Navigator Pro (document checklist tool - £150). 7. Traditional high street immigration solicitors (£2,000-8,000).",
  competitiveDifferentiation: "100x cost reduction (£35/month vs £5,000+ legal fees). 4 specialized AI agents vs single chatbot competitors. 109 professional tools vs 5-10 basic templates elsewhere. Real-time compliance scoring (unique feature). Multi-language support (8 languages vs English-only competitors). Document auto-extraction using Qwen VL Vision (no competitor offers this). Instant 24/7 guidance vs 2-4 week lawyer wait times.",
  revenue: "Subscription tiers: Free (3 tools, limited features) - lead generation. Basic £35/month (50 tools, AI chat, PDF exports) - solo applicants. Premium £99/month (109 tools, 4 AI agents, document extraction, priority support) - serious applicants. Enterprise £299/month (white-label, API access, unlimited users) - law firms, accelerators. One-off: Expedited plan review £150, Expert consultation booking 15% commission. Year 1: 300 Basic (£126K) + 100 Premium (£119K) + 10 Enterprise (£36K) = £281K ARR. Unit economics: LTV £420, CAC £25, LTV:CAC 17:1, Payback 1 month.",
  // Step 8 - Team
  founderEducation: "MSc Data Science - Leeds Beckett University, UK, 2023, Distinction\nAdvanced ML, Deep Learning, NLP, Statistical Modelling, Big Data Analytics\n\nBSc Information Technology & Business Information Systems - Middlesex University, UK, 2017, 2:1\nSystems Analysis, IT Management, Business Process Management\n\nAdvanced Diploma in Software Engineering - Aptech Computer Institute, 2016\nFull-stack development fundamentals, software architecture\n\nProfessional certifications: Google Data Analytics, IBM Data Analyst, Programming Fundamentals, SEO Specialist, FCA Financial Services Training",
  founderWorkHistory: "CTO/Lead Developer at Stackrise Ltd (Jun 2025-Present): Lead technical delivery for UK digital consultancy, shipping production-ready web solutions for SMEs and startups. Built secure admin/client portals (RBAC, team management, project tracking, support ticketing). Delivered AI-powered assistants using GPT/Qwen models with structured tool workflows. Implemented Stripe payments, invoice tracking, automated reminders, transactional email flows. Standardised analytics using GA4 and Microsoft Clarity.\n\nWeb & Performance Analyst at Qalhata Technologies (Nov 2024-Present): Owned corporate web presence measurement and reporting. Produced GA4 insights and stakeholder-friendly performance updates.\n\nWeb Developer at Deskstones Ltd (Feb 2024-Present): Led website rebuild focused on speed, SEO structure, and conversion uplift.\n\nWeb Developer/Analyst at Eden Health Care Private (2023-2024): Built and maintained healthcare web presence and lightweight internal tools.",
  founderAchievements: "Built and deployed entire Visa Assistant Global platform independently (109 tools, multi-agent AI, Stripe payments, document intelligence) - demonstrating exceptional full-stack and AI engineering capability.\n\nMSc Data Science (Distinction) - Leeds Beckett University 2023.\n\nBuilt 10+ production web applications with real paying users.\n\nDeveloped GCA Global Competency Assessment platform (32 countries, AI-powered certifications).\n\nBuilt F-RADAR geospatial renewable energy platform (UK public data integration).\n\nBuilt AutoInsight hotel analytics platform (100+ KPI dashboard, AI assistant).\n\nImplemented Stripe payment systems processing real transactions across multiple platforms.",
  relevantProjects: "Visa Assistant Global - Production platform, 109 tools, multi-agent AI (Nova/Sterling/Atlas/Sage), Stripe live payments, visual business plan exports with charts, Qwen VL Vision document intelligence, 7 active users.\n\nGCA Global Competency Assessment - AI-powered certification platform for professionals across 32 countries, React 18, TypeScript, Node.js/Express, PostgreSQL, Qwen AI, Stripe.\n\nF-RADAR - Agentic geospatial renewable energy feasibility platform with UK public data integration and interactive Leaflet mapping.\n\nAutoInsight - Hotel analytics platform with 100+ KPI dashboard and AI assistant, Recharts visualizations.\n\nAfro Grocers - Multilingual e-commerce with AI-powered customer support, i18n support.",
  experience: "Benedict (Ebuka) Umeh - Full-Stack Developer and AI Integrator with 7+ years experience. MSc Data Science (Distinction, Leeds Beckett 2023), BSc IT & Business Information Systems (Middlesex 2017). CTO/Lead Developer at Stackrise Ltd. Built the entire Visa Assistant Global platform independently: 109 tools, multi-agent AI system, Stripe integration, document intelligence. Core skills: React 18, TypeScript, Node.js/Express, PostgreSQL/Drizzle, Qwen AI APIs, function calling/tool use, GA4 analytics. Track record delivering production AI-powered SaaS with real paying customers.",
  // Compliance design (if present)
  complianceDesign: "Privacy-first architecture: GDPR-compliant data handling, encrypted storage (AES-256), ICO registration complete, OISC disclaimers on all AI outputs, explicit user consent for data processing, right to erasure implemented, data minimisation principles applied. No PII stored in AI training. Cookie consent with granular controls. Quarterly compliance reviews planned. Not regulated as legal advice - all outputs carry OISC-compliant disclaimers. PCI-DSS compliance via Stripe (no card data stored). WCAG 2.1 AA accessibility compliance in progress.",
  marketSizeCalculation: "TAM: £17 billion global immigration services market (850M+ visa applications annually). SAM: £2.1 billion UK immigration services market (600,000+ applications/year, £3,500 average spend). SOM Year 1: £180,000 (500 subscribers × £30/month × 12). SOM Year 3: £2.4 million (4,000 subscribers). SOM Year 5: £12 million (15,000 subscribers + B2B API licensing). Growth rate: 2% UK market share by Year 3 is conservative given no direct AI competitors.",
};
...
export default function QuestionnaireForm({ tier = 'premium' }: { tier?: string }) {
  ...
  const handleLoadIndustryTemplate = (industry: string, templateIndex: number) => {
    ...
    const industryTemplates: Record<string, Record<string, string>[]> = {
      globalvisa: [
        { // Visa Assistant Global - Benedict (Ebuka) Umeh - COMPREHENSIVE INNOVATOR FOUNDER VISA BUSINESS PLAN - REAL DATA
          businessName: "Visa Assistant Global (Stackrise Ltd)",
          industry: "Global LegalTech / Immigration Tech / AI SaaS Platform",
          problem: "The global visa and immigration industry is plagued by three critical problems: (1) COST BARRIER - Visa applicants worldwide pay £5,000-25,000+ in legal fees for advice that's often generic and template-based, excluding talented entrepreneurs from accessing proper guidance. (2) ACCESSIBILITY GAP - 850+ million people seek visas annually, but immigration lawyers are concentrated in major cities, leaving most applicants without expert support. Average wait time for legal consultations is 2-4 weeks. (3) HIGH REJECTION RATES - 40%+ of complex visa applications are rejected due to preventable errors, poor document preparation, or failure to demonstrate eligibility criteria correctly. The £17 billion global immigration services market is ripe for AI-powered disruption that can democratize access to expert-level guidance.",
          innovationStage: "mvp-complete",
          ...
          techStack: "Frontend: React 18, TypeScript, Tailwind CSS, Shadcn UI, Framer Motion, Recharts\nBackend: Node.js, Express.js, PostgreSQL, Drizzle ORM\nAI: Qwen API (qwen-plus, qwen-turbo, qwen-vl-plus), Function Calling/Tool Use, Multi-Agent Orchestration\nAuth: Google OAuth 2.0, Passport.js, Session Management, Cloudflare Turnstile bot protection\nPayments: Stripe (live subscriptions, invoicing, tier-based access)\nStorage: AWS S3 (documents), Object Storage for assets\nEmail: Hostinger SMTP, Resend API\nAnalytics: GA4, Custom real-time activity tracking\nExports: jsPDF, html-to-image, docx for visual business plan exports\nInfra: Railway deployment, Neon PostgreSQL",
          marketSize: "Global immigration services market: £17 billion (2024), growing 12% annually. UK Innovator Founder Visa market: 15,000+ applications annually at £5,000-15,000 average legal spend = £75-225M UK TAM. Expansion to 16 countries multiplies TAM significantly. Target 2% market share in Year 3 = £3M+ revenue opportunity. Secondary revenue streams: B2B licensing to immigration law firms, white-label solutions for accelerators, API access for enterprise clients.",
          founderBackground: "Benedict (Ebuka) Umeh - Full-Stack Developer and AI Integrator with 7+ years' experience delivering high-performance web applications and data-driven digital products. MSc Data Science (Leeds Beckett University, 2023), BSc Information Technology & Business Information Systems (Middlesex University, 2017), Advanced Diploma in Software Engineering (Aptech, 2016). Currently CTO/Lead Developer at Stackrise, Leeds. Built the entire Visa Assistant Global platform independently - 109 tools, multi-agent AI system, Stripe payments, document intelligence - demonstrating exceptional technical capability. Core skills: React, TypeScript, Node.js/Express, PostgreSQL, Qwen AI APIs, function calling/tool use, GA4 analytics. Proven track record building production AI-powered SaaS products.",
          scalabilityPlan: "Phase 1 (Year 1): UK market focus - acquire 500 paying subscribers, generate £180,000 ARR, partner with 5 immigration law firms, reinvest profits. Phase 2 (Year 2): Expand to 3 English-speaking markets (Canada, Australia, Ireland) - target 2,000 subscribers, £720,000 ARR. Phase 3 (Year 3): Global expansion to 10 countries with multi-language support, enterprise API, B2B licensing - target 5,000 subscribers, £2.4M ARR. Technology architecture supports horizontal scaling with minimal additional development per country.",
          ukGrowthStrategy: "UK is the ideal launchpad due to: (1) Large entrepreneurial immigrant population (300,000+ visa applications annually). (2) Tech-forward regulatory environment supporting AI innovation. (3) Strong endorsing body ecosystem for Innovator Founder Visa. (4) English language reduces localization complexity for initial launch. (5) Access to world-class AI talent and tech ecosystem. (6) Gateway to Commonwealth markets. Year 1 hiring plan: Part-time Customer Success (£12,000). Year 2: Full-time Developer (£45,000), Marketing Manager (£38,000). Founder handles all technical development initially.",
          ...
          revenueModel: "Tiered SaaS subscription model: FREE (3 tools, limited AI) - user acquisition. BASIC £35/month (50 tools, AI chat, PDF exports) - individual applicants. PREMIUM £99/month (all 109 tools, 4 AI agents, document extraction, priority support) - serious applicants. ENTERPRISE £299/month (white-label, API access, unlimited users) - immigration law firms and accelerators. Additional revenue: One-time expedited plan review £150, expert consultation booking commission 15%.",
          financialProjections: "Initial Capital: £5,000 (£2,000 personal savings + £4,000 family loan at 0% interest). Year 1: Revenue £0-500/mo (Months 1-3), £500-2,000/mo (Months 4-8), £2,000-5,000/mo (Months 9-12). Expenses: £400-800/mo. Break-even: Month 6. Year 1 Net: £15,000. Year 2: Revenue £5,000-15,000/mo. Expenses: £3,000-8,000/mo. Year 2 Net: £60,000. Year 3: Revenue £15,000-40,000/mo. Expenses: £10,000-25,000/mo. Year 3 Net: £180,000. Bootstrap model with profit reinvestment.",
          jobCreationPlan: "Year 1: Founder/CEO Benedict Umeh (£0 - equity only), Part-time Customer Success (£12,000/year). Total: 1.5 FTE. Year 2: Full-time Developer (£45,000), Marketing Manager (£38,000), Customer Success upgraded to full-time (£28,000). Total: 4.5 FTE. Year 3: Senior Developer (£55,000), Sales Manager (£42,000 + commission), Content Writer (£32,000), Operations Manager (£35,000). Total: 8.5 FTE. All UK-based positions.",
          endorsementReadiness: "Platform meets all three Innovator Founder Visa endorsement criteria: (1) INNOVATION - First multi-agent AI for visa applications, unique in the UK market, proprietary technology, 109 professional tools. (2) VIABILITY - Working MVP with 7 paying users, 2 immigration lawyers validating quality, clear revenue model, founder has 7+ years technical experience and MSc Data Science. (3) SCALABILITY - Global expansion roadmap, technology architecture supports multi-country rollout, £17B global TAM accessible. Evidence: Live platform demo, user testimonials, immigration lawyer validation, financial model, technical architecture documentation.",
          ipProtection: "Intellectual property strategy: (1) Trade secrets - Multi-agent orchestration algorithms, compliance scoring models, document extraction pipelines. (2) Copyright - All code, content, and training data (built entirely by founder). (3) Trademarks - 'Visa Assistant Global', 'Nova AI', 'Sterling AI', 'Atlas AI', 'Sage AI' pending registration. (4) Future patents - AI-powered visa compliance scoring method, multi-agent immigration guidance system. Data protection: GDPR compliant, encrypted storage, ICO registration.",
          riskMitigation: "Key risks and mitigation: (1) Regulatory changes - Modular content architecture allows rapid updates, monitoring of immigration policy changes. (2) AI accuracy - Multi-layer verification, human review options, clear disclaimers about legal advice boundaries (OISC compliant). (3) Competition - First-mover advantage, rapid feature development, strong IP protection. (4) Customer acquisition - B2B partnerships with immigration firms, content marketing, SEO strategy. (5) Technical scaling - Cloud-native architecture, horizontal scaling capability, 99.9% uptime target. (6) Funding - Bootstrap model minimizes external dependency, family loan at 0% interest.",
          socialImpact: "Democratizing access to immigration guidance creates significant social impact: (1) Enabling entrepreneurial talent to contribute to UK economy regardless of background. (2) Reducing financial barriers for skilled immigrants (100x cheaper than legal fees). (3) Improving visa success rates reducing family separation and uncertainty. (4) Creating UK jobs in growing tech sector (8 jobs by Year 3). (5) Contributing to UK's position as global tech hub. (6) Supporting diversity and inclusion in UK business ecosystem.",
          funding: "5000",
          fundingSources: "Personal savings: £2,000 (40%). Family loan: £4,000 at 0% interest, repayable over 24 months (60%). Total: £5,000. Bootstrap model with reinvestment of early revenue. No external investor dilution at seed stage. Platform already built - capital used for marketing, infrastructure, and initial operations.",
          monthlyProjections: "Year 1: Months 1-3: £0 revenue (beta testing), £400/month costs. Months 4-6: £1,500 MRR (30 subscribers), £600 costs. Months 7-12: £4,000 MRR (80 subscribers), £800 costs. Year 1 total: £27,000 revenue, £7,200 costs, £19,800 profit. Year 2: £10,000 MRR by month 24, £120,000 annual revenue. Year 3: £25,000 MRR, £300,000 annual revenue.",
          customerAcquisitionCost: "25",
          lifetimeValue: "420",
          paybackPeriod: "1",
          detailedCosts: "Technology & Infrastructure (£1,600): Cloud hosting £600/year (Railway), domain £50, database £300, API costs (Qwen AI) £400, dev tools £250. Marketing (£1,800): Content marketing £600, paid ads £800, events £200, social media tools £200. Operations (£1,200): Company formation £50, ICO registration £40, legal review £500, accounting £150, insurance £300, misc £160. Contractor Support (£1,000): Part-time support £600, design £250, copywriting £150. Contingency (£400). Total Year 1: £6,000.",
          competitors: "1. Fragomen (global immigration law firm - £5,000-25,000 per case). 2. PwC Legal Immigration Services (£3,000-15,000 per case). 3. Immigram (UK startup visa platform - £299-999). 4. Jobbatical (relocation/visa SaaS - $500+). 5. Boundless Immigration (US-focused - $750-2,000). 6. Visa Navigator Pro (document checklist tool - £150). 7. Traditional high street immigration solicitors (£2,000-8,000).",
          competitiveDifferentiation: "100x cost reduction (£35/month vs £5,000+ legal fees). 4 specialized AI agents vs single chatbot competitors. 109 professional tools vs 5-10 basic templates elsewhere. Real-time compliance scoring (unique feature). Multi-language support (8 languages vs English-only competitors). Document auto-extraction using GPT-4o Vision (no competitor offers this). Instant 24/7 guidance vs 2-4 week lawyer wait times.",
          customerInterviews: "25+ discovery interviews conducted: 12 visa applicants (Graduate visa holders, Skilled Worker visa holders exploring Innovator route), 5 immigration solicitors, 3 endorsing body representatives, 2 UKVI policy advisors, 3 startup founders who previously applied. Key insights: 78% found existing resources confusing, 85% couldn't afford lawyer fees, 92% wanted AI-powered document review. Immigration lawyers confirmed tool accuracy and expressed interest in white-label partnership.",
          lettersOfIntent: "2 immigration lawyers actively using platform to assist their clients (verbal agreements for formal partnership pending). 3 startup accelerators expressed interest in bulk licensing for their cohorts. 1 university international office exploring student entrepreneur pilot. Platform live with 7 paying users validating product-market fit.",
          willingnessToPay: "7 active paying users on live platform. Price testing showed optimal price point at £35/month (Basic), £99/month (Premium). 2 immigration lawyers paying Premium tier. Survey of 50 visa applicants: 73% willing to pay £20-50/month, 45% willing to pay £50-100/month for comprehensive solution. Competitor pricing analysis supports premium positioning.",
          marketSizeCalculation: "TAM: £17 billion global immigration services market (850M+ visa applications annually). SAM: £2.1 billion UK immigration services market (600,000+ visa applications/year, average spend £3,500). SOM Year 1: £180,000 (500 subscribers at £30/month average). SOM Year 3: £2.4 million (4,000 subscribers). SOM Year 5: £12 million (15,000 subscribers + B2B licensing).",
          regulatoryRequirements: "GDPR compliance (data protection for EU/UK users). ICO registration (£40-2,900 based on turnover). Cyber Essentials certification (£300-500). Terms of Service and Privacy Policy (legal review £500). OISC compliance disclaimer (not regulated advice - clear user disclaimers). PCI-DSS compliance via Stripe (no additional cost). Cookie consent and privacy notices. Accessibility compliance (WCAG 2.1 AA).",
          complianceTimeline: "Month 1: ICO registration complete, Privacy Policy and Terms of Service published. Month 2-3: Cyber Essentials certification. Month 4-6: GDPR audit and documentation. Month 7-9: Accessibility audit (WCAG 2.1). Month 10-12: ISO 27001 preparation for enterprise clients. Ongoing: OISC disclaimer prominently displayed, quarterly compliance reviews.",
          complianceBudget: "3500",
          jobCreation: "8",
          hiringPlan: "Year 1: Founder/CEO Benedict Umeh (£0 - equity only), Part-time Customer Success (£12,000/year). Year 2: Full-time Developer (£45,000), Marketing Manager (£38,000), Customer Success upgraded to full-time (£28,000). Year 3: Senior Developer (£55,000), Sales Manager (£42,000 + commission), Content Writer (£32,000), Operations Manager (£35,000). Total: 8 employees by Year 3.",
          specificRegions: "Phase 1 (Year 1): Greater London, Greater Manchester, Birmingham, Bristol, Edinburgh - highest concentration of visa applicants and startup ecosystems. Phase 2 (Year 2): Leeds, Liverpool, Glasgow, Cardiff, Cambridge, Oxford - university cities with international student entrepreneurs. Phase 3 (Year 3): Belfast, Newcastle, Nottingham, Sheffield - emerging tech hubs.",
          expansion: "Year 1: UK Innovator Founder Visa (109 tools complete). Year 2: Expand to Skilled Worker visa and Global Talent visa modules. Partnership with 10 immigration law firms for white-label solution. Year 3: Scale Business visa category, launch enterprise API for HR platforms. International: Canada (Express Entry), Australia (Business Innovation visa), UAE (Golden Visa).",
          internationalPlan: "Year 2-3: Canada (Express Entry), Australia (Business Innovation visa), UAE (Golden Visa) - markets with similar points-based/endorsement systems. Only after UK market validation and £500K+ ARR. Local legal partnerships required for each jurisdiction. Technology architecture already supports multi-country deployment.",
          vision: "5-Year Vision: Become the world's leading AI-powered visa preparation platform. 50,000+ users across 10 countries. £12M ARR. Team of 25+ specialists. Strategic partnerships with 50+ immigration law firms. API integrations with major HR platforms (Workday, SAP SuccessFactors). Potential acquisition target for legal tech or HR tech company at £50-100M valuation.",
          targetEndorser: "Primary: Envestors (tech-enabled businesses with scalable models, clear innovation, global potential). Criteria alignment: AI/SaaS platform, 109 proprietary tools, multi-agent architecture, global expansion roadmap. Alternative bodies: UKRI (deep-tech angle), Innovator International (sector-agnostic), Global Entrepreneurs Programme (if £50K+ investment available later).",
          contactPointsStrategy: "Contact 1 (Month 0): Initial endorsement interview and approval. Contact 2 (Month 6): First progress report - user growth, revenue milestones, product development updates. Contact 3 (Month 12): Annual review meeting - Year 1 achievements, financial performance, job creation progress. Contact 4 (Month 18): Mid-year check-in - expansion into new visa categories, partnership announcements. Contact 5 (Month 24): Second annual review - Year 2 growth, team expansion, market validation. Contact 6 (Month 30): Pre-ILR review - preparation for settlement, sustained innovation and UK economic contribution.",
          experience: "Benedict (Ebuka) Umeh - Full-Stack Developer and AI Integrator with 7+ years' experience. MSc Data Science (Leeds Beckett University, 2023). BSc Information Technology & Business Information Systems (Middlesex University, 2017). Advanced Diploma in Software Engineering (Aptech, 2016). Certifications: Google Data Analytics, IBM Data Analyst, Programming Fundamentals, SEO Specialist. Current Role: CTO/Lead Developer at Stackrise (Jun 2025-Present) - leading technical delivery, building AI-powered portals, Stripe payments, GA4 analytics. Previous: Web & Performance Analyst at Qalhata Technologies (Nov 2024-Present), Web Developer at Deskstones Ltd (Feb 2024-Present), Web Developer/Analyst at Eden Health Care (2023-2024). Built entire Visa Assistant platform independently: 109 tools, multi-agent AI, Stripe integration, document intelligence.",
          revenue: "Subscription tiers: Free (3 tools, limited features) - lead generation. Basic £35/month (50 tools, AI chat, PDF exports) - solo applicants. Premium £99/month (109 tools, 4 AI agents, document extraction, priority support) - serious applicants, immigration professionals. Enterprise £299/month (white-label, API access, unlimited users) - law firms, accelerators. One-off: Expedited plan review £150, Expert consultation booking 15% commission. Year 1: 300 Basic (£126K) + 100 Premium (£119K) + 10 Enterprise (£36K) = £281K ARR. Unit economics: LTV £420, CAC £25, LTV:CAC 17:1, Payback 1 month.",
          founderEducation: "MSc Data Science - Leeds Beckett University, UK, 2023 - Advanced AI/ML, data analytics, statistical modeling, practical outcome-focused engineering\nBSc Information Technology & Business Information Systems - Middlesex University, UK, 2017 - Systems analysis, IT management, business processes\nAdvanced Diploma in Software Engineering - Aptech Computer Institute, 2016 - Full-stack development fundamentals, software architecture\nProfessional certifications: Google Data Analytics, IBM Data Analyst, Programming Fundamentals, SEO Specialist",
          founderWorkHistory: "CTO/Lead Developer at Stackrise (Jun 2025-Present): Lead technical delivery for UK digital consultancy, shipping production-ready web solutions for SMEs and startups. Built secure admin/client portals (RBAC, team management, project tracking, support ticketing, document handling). Delivered AI-powered assistants using GPT models with structured tool workflows. Implemented Stripe payments, invoice tracking, automated reminders, transactional email flows. Standardised analytics using GA4 and Clarity.\n\nWeb & Performance Analyst at Qalhata Technologies (Nov 2024-Present): Owned corporate web presence measurement and reporting. Produced GA4 insights and stakeholder-friendly performance updates. Built reporting outputs and dashboards.\n\nWeb Developer at Deskstones Ltd (Feb 2024-Present): Led website rebuild focused on speed, SEO structure, and conversion uplift through improved UX and tracking.\n\nWeb Developer/Analyst at Eden Health Care Private (2023-2024): Built and maintained healthcare web presence and lightweight internal tools supporting scheduling/admin workflows. Improved operational efficiency.",
          founderAchievements: "Built and deployed 10+ production web applications with real users. Developed complete AI-powered SaaS platforms: UK Visa Assistant (109 tools, multi-agent AI, 7 users), GCA Global Competency Assessment (32 countries), F-RADAR geospatial renewable energy platform (UK public data integration, Leaflet mapping), AutoInsight hotel analytics (100+ KPI dashboard, AI assistant). Implemented Stripe payment systems processing real transactions. Led technical delivery at Stackrise serving multiple SME clients. MSc thesis in data science with practical AI/ML applications. 7+ years professional experience across healthcare, consulting, and analytics environments.",
          relevantProjects: "UK Visa Assistant Platform - Fully built production platform with 109 tools, multi-agent AI system (Nova, Sterling, Atlas, Sage), Stripe payment integration, visual business plan exports with charts, document intelligence using Qwen VL Vision\n\nGCA Global Competency Assessment - AI-powered certification platform for professionals across 32 countries, React 18, TypeScript, Node.js/Express, PostgreSQL, Qwen AI, Stripe\n\nF-RADAR - Agentic geospatial renewable energy feasibility platform with UK public data integration and interactive Leaflet mapping\n\nAutoInsight - Hotel analytics platform with 100+ KPI dashboard and AI assistant for insight retrieval, Recharts visualizations\n\nAI Virtual Hotel Concierge - High-volume FAQ chatbot handling guest inquiries, React, Node.js, MongoDB, LLM API\n\nAfro Grocers - Multilingual e-commerce with AI-powered customer support, i18n support",
        }
      ],
      visatech: [
        { // UK Visa Assistant - Benedict Umeh - COMPREHENSIVE
          ...
          aiMethodology: "Multi-agent AI architecture with specialized agents: Nova (Innovation & IP validation, NHS Light Blue), Sterling (Financial projections, investor readiness, Gold), Atlas (Market analysis, scaling strategies, Emerald), Sage (Regulatory requirements, document review, NHS Blue). Uses Qwen API with function calling for structured outputs. Adaptive interview system adjusts questions based on responses. Document extraction using Qwen VL (qwen-vl-plus) Vision API for CV and certificate parsing. Each agent has distinct personality and expertise area.",
          ...
          lifetimeValue: "280",
          paybackPeriod: "1",
          detailedCosts: "AI API costs (Qwen AI): £18K/year. Cloud infrastructure (Railway, AWS S3): £12K/year. Marketing & customer acquisition: £25K/year. Founder salary (Year 2): £50K. Legal & professional: £5K/year. Content creation & SEO: £8K/year. Total Year 1: £85K.",
    ...
    const baseTemplateData: Record<string, string> = {
      ...
      educationBackground: "MSc Data Science, Leeds Beckett University, UK, 2023. BSc IT & Business Information Systems, Middlesex University, UK, 2017. Advanced Diploma in Software Engineering, Aptech Computer Institute, 2016.",
      professionalCertifications: "IBM Data Analyst Professional. Google Data Analytics Professional. Google Analytics IQ. SEO Specialist. Web Development certification.",
      totalProfessionalExperience: "7",
      industryExperience: "7+ years in full-stack development and AI integration. 2023-2024: Web Developer/Analyst, Eden Health Care Private (healthcare web presence, workflow tools). Feb 2024-present: Web Developer, Deskstones Ltd (website rebuild, 45% performance improvement, 25% conversion uplift). Nov 2024-present: Web & Performance Analyst, Qalhata Technologies (GA4 insights, Power BI dashboards). Dec 2025-present: Lead Developer, StackRise (AI-powered assistants, admin portals, Stripe payments).",
      technicalSkillsProficiency: "React 18 (9/10), TypeScript (9/10), Node.js/Express (9/10), PostgreSQL (8/10), Qwen/OpenAI/Gemini APIs (9/10), Tailwind CSS/Shadcn UI (9/10), GA4/Power BI (8/10), Python/SQL (8/10), Stripe Integration (8/10), Drizzle ORM (8/10).",
      languagesSpoken: "English (Fluent), Igbo (Native).",
      linkedInProfile: "https://linkedin.com/in/ebukaumeh",
      portfolioUrl: "https://stackrise.co.uk",
      ...
      founderEducation: "MSc Data Science, Leeds Beckett University (2023). BSc IT & Business Information Systems, Middlesex University (2017). Advanced Diploma in Software Engineering, Aptech Computer Institute (2016).",
      founderWorkHistory: "Dec 2025-present: Lead Developer, StackRise (AI-powered assistants, admin portals, Stripe payments). Nov 2024-present: Web & Performance Analyst, Qalhata Technologies (GA4 insights, Power BI dashboards). Feb 2024-present: Web Developer, Deskstones Ltd (website rebuild, SEO, performance). 2023-2024: Web Developer/Analyst, Eden Health Care Private (healthcare web presence, workflow tools).",
      founderAchievements: "StackRise: Built secure admin/client portals with RBAC, AI-powered assistants using GPT-4o, and Stripe payment integrations. Qalhata Technologies: Reduced reporting turnaround by 80% with GA4 insights and Power BI dashboards. Deskstones: Improved page load performance by 45% and increased conversion rate by 25%.",
      relevantProjects: "UK Innovator Founder Visa Assistant (109 AI tools, multi-agent system). Abu Bakr Supermarkets (multilingual e-commerce with AI). F-RADAR (geospatial renewable energy platform). GCA Global Competency Assessment (AI certification platform across 32 countries). AutoInsight Hotel Analytics (KPI dashboard with AI assistant).",
      funding: "100000",
      ...
      experience: "Uniquely qualified: 7+ years full-stack development experience. MSc Data Science from Leeds Beckett University (research-grade technical skills). Proven track record building AI-powered platforms, admin portals, and analytics dashboards. Built and launched products used by 10K+ users. Network of 200+ SME contacts from customer discovery.",
