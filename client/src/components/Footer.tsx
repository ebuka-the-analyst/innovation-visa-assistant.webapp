...
export default function Footer() {
  ...
  const handleNewsletterSubscribe = () => {
    ...
    toast({
      ...
      description: "Send the email to request subscription",
    });
  };
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12 mb-12">
          <div className="space-y-4 lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground">
              AI-assisted business planning and preparation tools with selected official GOV.UK Innovator Founder updates. Not legal advice and no outcome is guaranteed.
            </p>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Request email updates about the platform and selected Innovator Founder information.
            </p>
            <div className="flex gap-2 max-w-md">
              ...
              />
              <Button onClick={handleNewsletterSubscribe} className="whitespace-nowrap" data-testid="button-newsletter-subscribe">Subscribe</Button>
            </div>
            <p className="text-xs text-muted-foreground mt-2">
              Clicking Subscribe opens your email client so you can send a subscription request to updates@innovatorfoundervisaassistant.co.uk.
            </p>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-border flex flex-col lg:flex-row justify-between items-center gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-3 text-center sm:text-left">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <p className="text-xs mt-1">Protected by applicable copyright law. Unauthorised reproduction is prohibited.</p>
            </div>
          </div>
