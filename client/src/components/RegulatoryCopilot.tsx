...
const MOCK_UPDATES: RegulationUpdate[] = [
  {
    id: '1',
    title: 'Innovator Founder Visa Route Updates - November 2025',
  ...
  {
    id: '3',
    title: 'UK Corporate Tax Rate for 2025/26',
...
const COMPLIANCE_ITEMS: ComplianceItem[] = [
  ...
  { id: 'c2', requirement: 'Endorsement Letter', status: 'pending', category: 'Endorsement', details: 'Letter from approved endorsing body confirming your business meets innovation criteria', dueDate: '2025-12-15' },
  { id: 'c3', requirement: 'Proof of Funds (£1,270 for 28 days)', status: 'attention', category: 'Financial', details: 'Bank statements showing maintenance funds held consecutively', dueDate: '2025-12-01' },
  ...
  { id: 'c5', requirement: 'TB Test Certificate', status: 'pending', category: 'Health', details: 'Required if applying from certain countries', dueDate: '2025-12-10' },
