...
export default function VisaAssistantDisclaimer() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 text-white text-sm px-4 py-5 flex items-center justify-between gap-4" style={{ zIndex: 9999, backgroundColor: '#1e40af' }}>
