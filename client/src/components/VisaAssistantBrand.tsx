        ...
        >
          <div className={`relative shrink-0 ${markSize}`} aria-hidden="true">
            ...
            >
              ...
              <path d="M6 18h23.2l18.1 38.4c2.1 4.4 5.2 4.3 7.4-.1L73.1 18H92L66 72.4C62.3 80.1 57.4 84 50.1 84c-7.7 0-12.5-4-16-11.4L6 18Z" fill={`url(#${gradientId})`} />
              <path d="M47.3 56.4 73.1 18H92L66 72.4C62.3 80.1 57.4 84 50.1 84c-4 0-7.3-1.1-10.1-3.4l7.3-24.2Z" fill="#2DBDF4" opacity="0.96" />
              <path d="M6 18h23.2l18.1 38.4c1 2.1 2.3 3.2 3.8 3.4-3.2 8.3-7 14.8-11.5 19.3-2.1-1.8-3.9-4.1-5.5-7L6 18Z" fill="#075BE8" opacity="0.92" />
              <path d="M44.5 29.7C53 23 61.9 16.5 72.7 10.9" fill="none" stroke="#075BE8" strokeWidth="3.3" strokeLinecap="round" />
              <path d="M72.4 7.5 79.3 3l3.6 1.2-3.3 5.4 9.5 2.3 1.4 2.8-12.8-.5-6.4 8.2-2.8-.8 3.3-8-6.5-2.6 1.5-2 7 1.2 3.2-4.1 2.2.9-2.3 6.2Z" fill="#075BE8" />
            </svg>
          </div>
