...
INSERT INTO ai_provider_settings (provider, enabled, priority, model, base_url)
VALUES
  ('openai', TRUE, 1, 'platform-latest', NULL),
  ('anthropic', FALSE, 2, 'claude-sonnet-4-20250514', NULL),
  ('custom', FALSE, 3, 'model-name', NULL)
