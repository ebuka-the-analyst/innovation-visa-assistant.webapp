...
export const FOUNDER_DATA: FounderProfile = {
  ...
  financial: {
    ...
    year2Costs: 96000,
    year3Costs: 180000,
    breakEvenPoint: "Month 4 (20 paying customers)",
    fundingStrategy: "Bootstrap with revenue from Day 1, reinvest 80% of profits for organic growth, consider seed investment at £100K+ ARR milestone",
    pricingTiers: [
  ...
  market: {
    ...
    som: "Year 1: 500 users (1% market share), Year 3: 5,000 users (10% market share), £480K revenue",
    competitors: [
      {
        name: "Relogate",
        website: "relogate.me",
  ...
  scalability: {
    ...
    year3Employees: 6,
    hiringPlan: [
      { role: "Part-time Virtual Assistant", year: 2, salary: 15000 },
      { role: "Customer Success Specialist", year: 2, salary: 30000 },
      { role: "Full Stack Developer", year: 3, salary: 50000 },
      { role: "Marketing Specialist", year: 3, salary: 35000 },
